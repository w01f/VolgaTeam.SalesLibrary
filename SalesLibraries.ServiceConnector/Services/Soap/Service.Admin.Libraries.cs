...
namespace SalesLibraries.ServiceConnector.Services.Soap
{
	...
	{
		public IEnumerable<SoapLibrary> GetLibraries(out string message)
		{
			message = string.Empty;
			var libraries = new List<SoapLibrary>();
			...
			if (client != null)
			{
				try
				{
					...
					if (!string.IsNullOrEmpty(sessionKey))
						libraries.AddRange(client.getLibraries(sessionKey) ?? new SoapLibrary[] { });
					else

namespace SalesDepot.TabPages
{
    partial class TabHomeControl
    {
        ...
        private void InitializeComponent()
        {
			...
			this.barCheckItemViewList = new DevExpress.XtraBars.BarCheckItem();
			this.barCheckItemViewAccordion = new DevExpress.XtraBars.BarCheckItem();
			...
			// pnMain
			// 
			this.pnMain.Controls.Add(this.splitContainerControl);
    ...
    " you want to ATTACH IT to an  email.";
		...
		private DevExpress.XtraBars.BarCheckItem barCheckItemViewList;
		private DevExpress.XtraBars.BarCheckItem barCheckItemViewAccordion;

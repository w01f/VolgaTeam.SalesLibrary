...
{
    partial class SolutionViewControl
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
			...
			this.barStaticItemFileNumber = new DevExpress.XtraBars.BarStaticItem();
			...
			this.gridColumnSearchAttribute = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.splitContainerControlMain.Panel1.Controls.Add(this.xtraTabControlSolutionModes);
			this.splitContainerControlMain.Panel1.MinSize = 250;
			...
			// 
			// xtraTabControlSolutionModes
			// 
			this.xtraTabControlSolutionModes.AppearancePage.Header.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.xtraTabControlSolutionModes.AppearancePage.Header.Options.UseFont = true;
			this.xtraTabControlSolutionModes.AppearancePage.HeaderActive.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.xtraTabControlSolutionModes.AppearancePage.HeaderActive.Options.UseFont = true;
			this.xtraTabControlSolutionModes.AppearancePage.HeaderDisabled.Font = new System.Drawing.Font("Arial", 9.75F);
			this.xtraTabControlSolutionModes.AppearancePage.HeaderDisabled.Options.UseFont = true;
			this.xtraTabControlSolutionModes.AppearancePage.HeaderHotTracked.Font = new System.Drawing.Font("Arial", 9.75F);
			this.xtraTabControlSolutionModes.AppearancePage.HeaderHotTracked.Options.UseFont = true;
			this.xtraTabControlSolutionModes.AppearancePage.PageClient.Font = new System.Drawing.Font("Arial", 9.75F);
			this.xtraTabControlSolutionModes.AppearancePage.PageClient.Options.UseFont = true;
			this.xtraTabControlSolutionModes.Dock = System.Windows.Forms.DockStyle.Fill;
			this.xtraTabControlSolutionModes.Location = new System.Drawing.Point(0, 0);
			this.xtraTabControlSolutionModes.Name = "xtraTabControlSolutionModes";
			this.xtraTabControlSolutionModes.SelectedTabPage = this.xtraTabPageAddDate;
			this.xtraTabControlSolutionModes.Size = new System.Drawing.Size(291, 652);
			this.xtraTabControlSolutionModes.TabIndex = 0;
			this.xtraTabControlSolutionModes.TabPages.AddRange(new DevExpress.XtraTab.XtraTabPage[] {
            this.xtraTabPageSearchTags,
            this.xtraTabPageKeyWords,
            this.xtraTabPageAddDate});
			this.xtraTabControlSolutionModes.SelectedPageChanged += new DevExpress.XtraTab.TabPageChangedEventHandler(this.xtraTabControlSolutionModes_SelectedPageChanged);
			// 
			// xtraTabPageAddDate
			// 
            ...
            this.barLinksOperations});
			this.barManager.DockControls.Add(this.barDockControlTop);
			this.barManager.DockControls.Add(this.barDockControlBottom);
			this.barManager.DockControls.Add(this.barDockControlLeft);
			this.barManager.DockControls.Add(this.barDockControlRight);
			this.barManager.Form = this.pnLins;
			...
			// barLinksOperations
			// 
			this.barLinksOperations.BarName = "Links Operations";
			this.barLinksOperations.DockCol = 0;
			this.barLinksOperations.DockRow = 0;
			this.barLinksOperations.DockStyle = DevExpress.XtraBars.BarDockStyle.Top;
            ...
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, this.barStaticItemFileNumber, DevExpress.XtraBars.BarItemPaintStyle.Caption)});
			...
			this.barLinksOperations.OptionsBar.UseWholeRow = true;
			this.barLinksOperations.Text = "Links Operations";
			// 
			// barButtonItemOpenLink
			// 
			...
			toolTipItem3.Text = "Convert the selected file to Adobe PDF format";
			superToolTip3.Items.Add(toolTipTitleItem3);
			superToolTip3.Items.Add(toolTipItem3);
			this.barButtonItemSaveAsPDF.SuperTip = superToolTip3;
			...
			toolTipItem4.Text = "Email the selected file ";
			superToolTip4.Items.Add(toolTipTitleItem4);
			superToolTip4.Items.Add(toolTipItem4);
			this.barButtonItemEmailLink.SuperTip = superToolTip4;
			...
			toolTipItem5.Text = "Print the selected file ";
			...
			// pnLins
			// 
			this.pnLins.Controls.Add(this.gridControlFiles);
			this.pnLins.Controls.Add(this.barDockControlLeft);
			this.pnLins.Controls.Add(this.barDockControlRight);
			this.pnLins.Controls.Add(this.barDockControlBottom);
			this.pnLins.Controls.Add(this.barDockControlTop);
			...
			this.gridViewFiles.RowStyle += new DevExpress.XtraGrid.Views.Grid.RowStyleEventHandler(this.gridViewFiles_RowStyle);
			...
			// 
			// gridColumnSearchAttribute
			// 
			this.gridColumnSearchAttribute.Caption = "The files below";
			this.gridColumnSearchAttribute.FieldName = "CriteriaOverlap";
			this.gridColumnSearchAttribute.Name = "gridColumnSearchAttribute";
			// 
			// gridColumnWidget
			// 
			...
			// 
			this.splitContainerControlSerachResults.Dock = System.Windows.Forms.DockStyle.Fill;
			this.splitContainerControlSerachResults.FixedPanel = DevExpress.XtraEditors.SplitFixedPanel.Panel2;
			...
			// barLinkOperations
			// 
			this.barLinkOperations.BarName = "Link Operations";
			this.barLinkOperations.CanDockStyle = DevExpress.XtraBars.BarCanDockStyle.Top;
			this.barLinkOperations.DockCol = 0;
			this.barLinkOperations.DockRow = 0;
			this.barLinkOperations.DockStyle = DevExpress.XtraBars.BarDockStyle.Top;
			this.barLinkOperations.OptionsBar.AllowQuickCustomization = false;
			this.barLinkOperations.OptionsBar.DrawDragBorder = false;
			this.barLinkOperations.Text = "Link Operations";
			// 
			// imageList
			// 
			this.imageList.ImageStream = ((System.Windows.Forms.ImageListStreamer)(resources.GetObject("imageList.ImageStream")));
			this.imageList.TransparentColor = System.Drawing.Color.Transparent;
			this.imageList.Images.SetKeyName(0, "SearchTags.png");
        ...
        public DevExpress.XtraTab.XtraTabPage xtraTabPageAddDate;
        public DevExpress.XtraTab.XtraTabPage xtraTabPageKeyWords;
        private System.Windows.Forms.Label laSearchAddDate;
        private System.Windows.Forms.PictureBox pbSearchAddDate;
        private System.Windows.Forms.Label laSearchByTitles;
        private System.Windows.Forms.PictureBox pbSearchByFiles;
        private System.Windows.Forms.Label laDateRangeStart;
        private System.Windows.Forms.Label laDateRangeEnd;
        public System.Windows.Forms.RadioButton rbLastMonth;
        public System.Windows.Forms.RadioButton rbLastHalfMonth;
        public System.Windows.Forms.RadioButton rbLastDay;
        ...
        private DevExpress.XtraEditors.CheckEdit checkEditNetwork;
        private DevExpress.XtraEditors.CheckEdit checkEditWeb;
        ...
        private System.Windows.Forms.Panel pnEmptyPreview;
        private System.Windows.Forms.Panel pnPreviewArea;
        private System.Windows.Forms.Panel pnSearchByFilesMatchType;

namespace SalesDepot.PresentationClasses.WallBin
{
    partial class WallBinTreeListControl
    {
        ...
        private void InitializeComponent()
        {
			...
			this.xtraTabControlFiles.Size = new System.Drawing.Size(300, 397);
			...
			this.pnLeft.Size = new System.Drawing.Size(300, 500);
			...
			this.pnRight.Controls.Add(this.barDockControlLeft);
			this.pnRight.Controls.Add(this.barDockControlRight);
			this.pnRight.Controls.Add(this.barDockControlBottom);
			this.pnRight.Controls.Add(this.barDockControlTop);
			...
			this.barManager.Form = this.pnRight;

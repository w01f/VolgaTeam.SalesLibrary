...
namespace SalesDepot.CustomControls
{
    ...
    {
        private List<BusinessClasses.IFileViewer> _fileViewers = new List<BusinessClasses.IFileViewer>();
        ...
        public SolutionViewControl()
        {
            ...
            gridControlFiles.DataSource = new BindingList<BusinessClasses.IFileViewer>(_fileViewers);
        ...
        public void ApplySearchCriteria(BusinessClasses.LibraryFile[] files)
        {
            ...
            using (ToolForms.FormProgress form = new ToolForms.FormProgress())
            {
                ...
                System.Threading.Thread thread = new System.Threading.Thread(new System.Threading.ThreadStart(delegate()
                {
                    ...
                    {
                        foreach (BusinessClasses.IFileViewer file in _fileViewers)
                    ...
                    {
                        BusinessClasses.IFileViewer viewer = null;
                        switch (file.Type)
                        {
            ...
            ((BindingList<BusinessClasses.IFileViewer>)gridControlFiles.DataSource).ResetBindings();
        ...
        private void Search()
        {
            if (FormMain.Instance.CurrentPackage != null)
            {
                ...
                else if (FormMain.Instance.buttonItemHomeSearchByFileName.Checked)
                {
                    ...
                    {
                        files = FormMain.Instance.CurrentPackage.Package.SearchByName(criteria, checkEditSearchByFilesExactMatch.Checked, BusinessClasses.FileTypes.Other);
                    }
                    else
                    {
                        List<BusinessClasses.LibraryFile> filesByName = new List<BusinessClasses.LibraryFile>();
                        if (checkEditExcel.Checked)
                            filesByName.AddRange(FormMain.Instance.CurrentPackage.Package.SearchByName(criteria, checkEditSearchByFilesExactMatch.Checked, BusinessClasses.FileTypes.Excel));
                        if (checkEditFolders.Checked)
                            filesByName.AddRange(FormMain.Instance.CurrentPackage.Package.SearchByName(criteria, checkEditSearchByFilesExactMatch.Checked, BusinessClasses.FileTypes.Folder));
                        if (checkEditNetwork.Checked)
                            filesByName.AddRange(FormMain.Instance.CurrentPackage.Package.SearchByName(criteria, checkEditSearchByFilesExactMatch.Checked, BusinessClasses.FileTypes.Network));
                        if (checkEditPDF.Checked)
                            filesByName.AddRange(FormMain.Instance.CurrentPackage.Package.SearchByName(criteria, checkEditSearchByFilesExactMatch.Checked, BusinessClasses.FileTypes.PDF));
                        if (checkEditPowerPoint.Checked)
                        {
                            filesByName.AddRange(FormMain.Instance.CurrentPackage.Package.SearchByName(criteria, checkEditSearchByFilesExactMatch.Checked, BusinessClasses.FileTypes.BuggyPresentation));
                            filesByName.AddRange(FormMain.Instance.CurrentPackage.Package.SearchByName(criteria, checkEditSearchByFilesExactMatch.Checked, BusinessClasses.FileTypes.FriendlyPresentation));
                            filesByName.AddRange(FormMain.Instance.CurrentPackage.Package.SearchByName(criteria, checkEditSearchByFilesExactMatch.Checked, BusinessClasses.FileTypes.OtherPresentation));
                        }
                        if (checkEditVideo.Checked)
                        {
                            filesByName.AddRange(FormMain.Instance.CurrentPackage.Package.SearchByName(criteria, checkEditSearchByFilesExactMatch.Checked, BusinessClasses.FileTypes.MediaPlayerVideo));
                            filesByName.AddRange(FormMain.Instance.CurrentPackage.Package.SearchByName(criteria, checkEditSearchByFilesExactMatch.Checked, BusinessClasses.FileTypes.QuickTimeVideo));
                        }
                        if (checkEditWeb.Checked)
                            filesByName.AddRange(FormMain.Instance.CurrentPackage.Package.SearchByName(criteria, checkEditSearchByFilesExactMatch.Checked, BusinessClasses.FileTypes.Url));
                        if (checkEditWord.Checked)
                            filesByName.AddRange(FormMain.Instance.CurrentPackage.Package.SearchByName(criteria, checkEditSearchByFilesExactMatch.Checked, BusinessClasses.FileTypes.Word));
                ...
                else if (FormMain.Instance.buttonItemHomeSearchRecentFiles.Checked)
                {
                    ...
                    files = FormMain.Instance.CurrentPackage.Package.SearchByDate(startDate, endDate);
                    if (files.Where(x => x.Type == BusinessClasses.FileTypes.BuggyPresentation || x.Type == BusinessClasses.FileTypes.FriendlyPresentation || x.Type == BusinessClasses.FileTypes.OtherPresentation).Count() > 25)
                    {

namespace SalesLibraries.CloudAdmin.PresentationLayer.Wallbin.Links.SingleSettings
{
	partial class ExpiredDateOptions
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkBoxLabelLink.Location = new System.Drawing.Point(31, 144);
			...
			this.timeEditExpirationTime.Location = new System.Drawing.Point(303, 20);
			...
			this.checkBoxSendEmailWhenDelete.Location = new System.Drawing.Point(31, 181);
			...
			this.laExpireddateActions.Location = new System.Drawing.Point(9, 112);
			...
			this.dateEditExpirationDate.Location = new System.Drawing.Point(177, 20);
			...
			this.laAddDateValue.Location = new System.Drawing.Point(28, 55);
			this.laAddDateValue.Name = "laAddDateValue";
			this.laAddDateValue.Size = new System.Drawing.Size(375, 18);
			this.laAddDateValue.TabIndex = 1;
			this.laAddDateValue.Text = "(this link was originally added on {0})";
			// 
			// checkBoxEnableExpiredLinks
			// 
			this.checkBoxEnableExpiredLinks.AutoSize = true;
			this.checkBoxEnableExpiredLinks.Checked = true;
			this.checkBoxEnableExpiredLinks.CheckState = System.Windows.Forms.CheckState.Checked;
			...
			this.checkBoxEnableExpiredLinks.Location = new System.Drawing.Point(12, 22);
			this.checkBoxEnableExpiredLinks.Name = "checkBoxEnableExpiredLinks";
			this.checkBoxEnableExpiredLinks.Size = new System.Drawing.Size(159, 20);
			this.checkBoxEnableExpiredLinks.TabIndex = 2;
			this.checkBoxEnableExpiredLinks.Text = "This Link Expires on:";
			...
			this.Controls.Add(this.checkBoxLabelLink);
			this.Controls.Add(this.checkBoxSendEmailWhenDelete);
			this.Controls.Add(this.timeEditExpirationTime);
			this.Controls.Add(this.laExpireddateActions);
			this.Controls.Add(this.checkBoxEnableExpiredLinks);
			this.Controls.Add(this.dateEditExpirationDate);
			this.Controls.Add(this.laAddDateValue);

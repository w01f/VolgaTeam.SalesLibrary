namespace SalesLibraries.CloudAdmin.PresentationLayer.Wallbin.Links.HyperlinkEdit
{
	partial class InternalWallbinLinkEditControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.comboBoxEditLibraryName.TabIndex = 69;
			...
			this.comboBoxEditPageName.TabIndex = 70;
			// 
			...
			this.checkEditOpenOnSamePage.TabIndex = 71;
			// 
			// comboBoxEditStyle
			// 
			...
			this.comboBoxEditStyle.TabIndex = 72;
			// 
			// labelControlStyle
			// 
			...
			this.labelControlStyle.TabIndex = 74;

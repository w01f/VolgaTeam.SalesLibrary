namespace SalesLibraries.CloudAdmin.PresentationLayer.Wallbin.LinkBundles.SingleBundle
{
	partial class StrategyEditControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelControlTitle.Text = "<size=+2>Do you need to share any details about Sales Strategy? Target Prospects?" +
    " General Sales Cycle? Digital or Mobile Sales Strategy?</size>";
			...
			this.pictureBoxLogo.Image = global::SalesLibraries.CloudAdmin.Properties.Resources.BundlesEditorStrategyLogo;

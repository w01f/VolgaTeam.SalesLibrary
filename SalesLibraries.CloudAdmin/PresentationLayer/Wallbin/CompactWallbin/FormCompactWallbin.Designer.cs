namespace SalesLibraries.CloudAdmin.PresentationLayer.Wallbin.CompactWallbin
{
	partial class FormCompactWallbin
	{
		...
		private void InitializeComponent()
		{
			...
			this.panelSyncProgress = new System.Windows.Forms.Panel();
			this.labelControlSyncProgress = new DevExpress.XtraEditors.LabelControl();
			this.circularProgressSyncProgress = new DevComponents.DotNetBar.Controls.CircularProgress();
			this.panelSyncInfo = new System.Windows.Forms.Panel();
			this.labelControlSyncInfo = new DevExpress.XtraEditors.LabelControl();
			...
			this.panelSyncProgress.SuspendLayout();
			this.panelSyncInfo.SuspendLayout();
			...
			this.buttonXExit.Location = new System.Drawing.Point(265, 6);
			this.buttonXExit.Name = "buttonXExit";
			this.buttonXExit.Size = new System.Drawing.Size(130, 32);
			...
			this.buttonXBack.Location = new System.Drawing.Point(3, 6);
			this.buttonXBack.Name = "buttonXBack";
			this.buttonXBack.Size = new System.Drawing.Size(130, 32);
			...
			// barStaticItemLogo
			// 
			this.barStaticItemLogo.Glyph = global::SalesLibraries.CloudAdmin.Properties.Resources.HomeLogo;
			...
			this.barLargeButtonItemSync.Glyph = global::SalesLibraries.CloudAdmin.Properties.Resources.RibbonSync;
			...
			this.panelBottom.Controls.Add(this.buttonXExit);
			this.panelBottom.Controls.Add(this.buttonXBack);
			...
			this.panelBottom.Size = new System.Drawing.Size(398, 45);
			this.panelBottom.TabIndex = 11;
			// 
			// panelMain
			// 
			this.panelMain.BackColor = System.Drawing.Color.Transparent;
			this.panelMain.Controls.Add(this.treeListWallbinItems);
			this.panelMain.Controls.Add(this.panelSyncProgress);
			this.panelMain.Controls.Add(this.panelSyncInfo);
			...
			this.treeListWallbinItems.Dock = System.Windows.Forms.DockStyle.Fill;
			this.treeListWallbinItems.Location = new System.Drawing.Point(0, 0);
			...
			// panelSyncProgress
			// 
			this.panelSyncProgress.Controls.Add(this.labelControlSyncProgress);
			...
			this.panelSyncProgress.TabIndex = 16;
			this.panelSyncProgress.Visible = false;
			// 
			// labelControlSyncProgress
			// 
			this.labelControlSyncProgress.AllowHtmlString = true;
			this.labelControlSyncProgress.Appearance.BackColor = System.Drawing.Color.White;
			this.labelControlSyncProgress.Appearance.ForeColor = System.Drawing.Color.Black;
			this.labelControlSyncProgress.Appearance.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.labelControlSyncProgress.AutoSizeMode = DevExpress.XtraEditors.LabelAutoSizeMode.None;
			this.labelControlSyncProgress.Dock = System.Windows.Forms.DockStyle.Fill;
			this.labelControlSyncProgress.Location = new System.Drawing.Point(68, 5);
			this.labelControlSyncProgress.Name = "labelControlSyncProgress";
			this.labelControlSyncProgress.Size = new System.Drawing.Size(325, 30);
			this.labelControlSyncProgress.StyleController = this.styleController;
			this.labelControlSyncProgress.TabIndex = 2;
			this.labelControlSyncProgress.Text = "<color=green><size=+1>Uploading your HTML5 Site…</size></color>";
			// 
			...
			this.circularProgressSyncProgress.Dock = System.Windows.Forms.DockStyle.Left;
			this.circularProgressSyncProgress.FocusCuesEnabled = false;
			this.circularProgressSyncProgress.Location = new System.Drawing.Point(5, 5);
			...
			this.circularProgressSyncProgress.Size = new System.Drawing.Size(63, 30);
			...
			this.panelSyncInfo.TabIndex = 15;
			this.panelSyncInfo.Visible = false;
			// 
			// labelControlSyncInfo
			// 
			this.labelControlSyncInfo.AllowHtmlString = true;
			this.labelControlSyncInfo.Appearance.BackColor = System.Drawing.Color.White;
			this.labelControlSyncInfo.Appearance.ForeColor = System.Drawing.Color.Black;
			this.labelControlSyncInfo.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.labelControlSyncInfo.Appearance.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.labelControlSyncInfo.AutoSizeMode = DevExpress.XtraEditors.LabelAutoSizeMode.None;
			this.labelControlSyncInfo.Dock = System.Windows.Forms.DockStyle.Fill;
			this.labelControlSyncInfo.Location = new System.Drawing.Point(5, 5);
			this.labelControlSyncInfo.Name = "labelControlSyncInfo";
			this.labelControlSyncInfo.Size = new System.Drawing.Size(388, 30);
			this.labelControlSyncInfo.StyleController = this.styleController;
			this.labelControlSyncInfo.TabIndex = 0;
			// 
			// pnTreeViewProgress
			// 
			...
			this.pnTreeViewProgress.TabIndex = 14;
			...
			this.laTreeViewProgressLabel.ForeColor = System.Drawing.Color.Black;
			...
			this.laTreeViewProgressLabel.Size = new System.Drawing.Size(325, 30);
			...
			this.panelTop.Controls.Add(this.buttonXCollapse);
			...
			this.buttonXCollapse.Location = new System.Drawing.Point(265, 6);
			this.buttonXCollapse.Name = "buttonXCollapse";
			this.buttonXCollapse.Size = new System.Drawing.Size(130, 32);
			...
			this.buttonXExpand.Location = new System.Drawing.Point(3, 6);
			this.buttonXExpand.Name = "buttonXExpand";
			this.buttonXExpand.Size = new System.Drawing.Size(130, 32);
			...
			this.panelSyncProgress.ResumeLayout(false);
			this.panelSyncInfo.ResumeLayout(false);
		...
		private System.Windows.Forms.Panel panelSyncInfo;
		private DevExpress.XtraEditors.LabelControl labelControlSyncInfo;

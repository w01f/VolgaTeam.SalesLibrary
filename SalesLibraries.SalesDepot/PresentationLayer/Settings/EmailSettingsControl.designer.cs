namespace SalesLibraries.SalesDepot.PresentationLayer.Settings
{
	partial class EmailSettingsControl
	{
		...
		private void InitializeComponent()
		{
			...
			// pictureEditLogo
			// 
			this.pictureEditLogo.EditValue = global::SalesLibraries.SalesDepot.Properties.Resources.SettingsEmail;
			// 
			...
			this.simpleLabelItemTitle.Text = "<size=+2>Change your Email settings</size>";
			this.simpleLabelItemTitle.TextSize = new System.Drawing.Size(190, 18);
			// 
			// layoutControl
			// 

namespace SalesLibraries.SiteManager.PresentationClasses.Activities.VideoLinkData
{
	public partial class GroupControl
    {
        ...
        private void InitializeComponent()
        {
			...
			this.gridColumnDateModify = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			...
			this.gridColumnFileName.Width = 110;
			// 
			// gridColumnLinkName
			// 
			...
			this.gridColumnLinkName.Width = 119;
			// 
			...
			this.gridColumnCategoryGroups.Width = 135;
			// 
			...
			this.gridColumnCategoryTags.Width = 128;
			// 
			// gridColumnKeywords
			// 
			...
			this.gridColumnKeywords.Width = 101;
			// 
			// gridColumnNote
			// 
			...
			this.gridColumnHoverNote.Width = 111;
			// 
			// gridColumnMp4Url
			// 
			...
			this.gridColumnMp4Url.Width = 315;
			// 
			...
			this.gridColumnThumbUrl.Width = 298;
			// 
			// gridColumnStation
			// 
			...
			// 
			// gridColumnDateModify
			// 
			this.gridColumnDateModify.Caption = "Date Modified";
			this.gridColumnDateModify.DisplayFormat.FormatString = "d";
			this.gridColumnDateModify.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
			this.gridColumnDateModify.FieldName = "DateModify";
			this.gridColumnDateModify.Name = "gridColumnDateModify";
			this.gridColumnDateModify.OptionsColumn.AllowEdit = false;
			this.gridColumnDateModify.OptionsColumn.FixedWidth = true;
			this.gridColumnDateModify.OptionsColumn.ReadOnly = true;
			this.gridColumnDateModify.Visible = true;
			this.gridColumnDateModify.Width = 106;
			// 
			// gridBandMain
			// 
		...
		private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn gridColumnDateModify;

		...
		public void UpdateData(bool showMessages, ref string updateMessage)
		{
			...
			if (showMessages)
			{
				using (var form = new FormProgress())
				{
					...
					{
						_userRecords.AddRange(WebSiteManager.Instance.SelectedSite.GetNavigationUserReport(StartDate, EndDate, out message));
						_groupRecords.AddRange(WebSiteManager.Instance.SelectedSite.GetNavigationGroupReport(StartDate, EndDate, out message));

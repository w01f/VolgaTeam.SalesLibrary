...
namespace SalesLibraries.BatchTagger.Configuration
{
	class MetaDataContainer
	{
		...
		{
			var cacheFile = Path.Combine(AppManager.Instance.Resources.MetaDataCacheFolderPath, String.Format("{0}.cache", dataTag));
		...
		public void Save()
		{
			...
			File.WriteAllText(Path.Combine(AppManager.Instance.Resources.MetaDataCacheFolderPath, String.Format("{0}.cache", DataTag)), JsonConvert.SerializeObject(this));
		}

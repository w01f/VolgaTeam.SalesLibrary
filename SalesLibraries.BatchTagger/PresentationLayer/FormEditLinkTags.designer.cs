...
{
	partial class FormEditLinkTags
	{
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.imageCollectionCategories = new DevExpress.Utils.ImageCollection();
			...
			this.buttonXOK.Location = new System.Drawing.Point(737, 523);
			...
			this.buttonXCancel.Location = new System.Drawing.Point(847, 523);
			...
			this.xtraTabControl.Size = new System.Drawing.Size(930, 458);
			...
			this.xtraTabPageCategories.Size = new System.Drawing.Size(928, 430);
			...
			this.splitContainerCategories.Size = new System.Drawing.Size(624, 420);
			...
			this.treeListCategories.Size = new System.Drawing.Size(250, 382);
			...
			this.panelCategoriesInfo.Location = new System.Drawing.Point(629, 5);
			...
			this.panelCategoriesInfo.Size = new System.Drawing.Size(294, 420);
			...
			this.panelControlCategoriesInfoInner.Size = new System.Drawing.Size(289, 420);
			...
			this.xtraScrollableControlCategoriesInfo.Size = new System.Drawing.Size(285, 416);
			...
			this.labelControlCategoriesInfo.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Top;
			this.labelControlCategoriesInfo.Appearance.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.labelControlCategoriesInfo.AutoSizeMode = DevExpress.XtraEditors.LabelAutoSizeMode.Vertical;
			this.labelControlCategoriesInfo.Dock = System.Windows.Forms.DockStyle.Top;
			this.labelControlCategoriesInfo.HtmlImages = this.imageCollectionCategories;
			this.labelControlCategoriesInfo.ImageAlignToText = DevExpress.XtraEditors.ImageAlignToText.LeftCenter;
			...
			// 
			// imageCollectionCategories
			// 
			this.imageCollectionCategories.ImageSize = new System.Drawing.Size(24, 24);
			...
			this.xtraTabPageKeywords.Size = new System.Drawing.Size(928, 430);
			...
			this.buttonXAddKeyWord.Image = global::SalesLibraries.BatchTagger.Properties.Resources.ButtonPlus;
			...
			this.gridControlKeywords.Size = new System.Drawing.Size(907, 378);
			...
			// gridViewKeywords
			// 
			this.gridViewKeywords.Appearance.FocusedCell.Font = new System.Drawing.Font("Arial", 9.75F);
			this.gridViewKeywords.Appearance.FocusedCell.Options.UseFont = true;
			this.gridViewKeywords.Appearance.FocusedRow.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.gridViewKeywords.Appearance.FocusedRow.Options.UseFont = true;
			this.gridViewKeywords.Appearance.HeaderPanel.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.gridViewKeywords.Appearance.HeaderPanel.Options.UseFont = true;
			this.gridViewKeywords.Appearance.Row.Font = new System.Drawing.Font("Arial", 9.75F);
			this.gridViewKeywords.Appearance.Row.Options.UseFont = true;
			this.gridViewKeywords.Appearance.SelectedRow.Font = new System.Drawing.Font("Arial", 9.75F);
			this.gridViewKeywords.Appearance.SelectedRow.Options.UseFont = true;
			this.gridViewKeywords.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.gridColumnKeywordsValue});
			this.gridViewKeywords.GridControl = this.gridControlKeywords;
			this.gridViewKeywords.Name = "gridViewKeywords";
			this.gridViewKeywords.OptionsBehavior.AllowDeleteRows = DevExpress.Utils.DefaultBoolean.False;
			this.gridViewKeywords.OptionsCustomization.AllowColumnMoving = false;
			this.gridViewKeywords.OptionsCustomization.AllowColumnResizing = false;
			this.gridViewKeywords.OptionsCustomization.AllowFilter = false;
			this.gridViewKeywords.OptionsCustomization.AllowGroup = false;
			this.gridViewKeywords.OptionsCustomization.AllowQuickHideColumns = false;
			this.gridViewKeywords.OptionsCustomization.AllowSort = false;
			this.gridViewKeywords.OptionsSelection.EnableAppearanceFocusedCell = false;
			this.gridViewKeywords.OptionsSelection.EnableAppearanceFocusedRow = false;
			this.gridViewKeywords.OptionsSelection.EnableAppearanceHideSelection = false;
			this.gridViewKeywords.OptionsView.ShowColumnHeaders = false;
			this.gridViewKeywords.OptionsView.ShowGroupExpandCollapseButtons = false;
			this.gridViewKeywords.OptionsView.ShowGroupPanel = false;
			this.gridViewKeywords.OptionsView.ShowIndicator = false;
			this.gridViewKeywords.OptionsView.ShowPreviewRowLines = DevExpress.Utils.DefaultBoolean.False;
			this.gridViewKeywords.RowHeight = 35;
			// 
			// gridColumnKeywordsValue
			// 
			this.gridColumnKeywordsValue.Caption = "Value";
			this.gridColumnKeywordsValue.ColumnEdit = this.repositoryItemButtonEditKeyword;
			this.gridColumnKeywordsValue.FieldName = "Name";
			this.gridColumnKeywordsValue.Name = "gridColumnKeywordsValue";
			this.gridColumnKeywordsValue.ShowButtonMode = DevExpress.XtraGrid.Views.Base.ShowButtonModeEnum.ShowAlways;
			this.gridColumnKeywordsValue.Visible = true;
			this.gridColumnKeywordsValue.VisibleIndex = 0;
			// 
			...
			this.repositoryItemButtonEditKeyword.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
			this.repositoryItemButtonEditKeyword.ButtonClick += new DevExpress.XtraEditors.Controls.ButtonPressedEventHandler(this.OnKeywordsEditorButtonClick);
			// 
			// panelMainContainer
			// 
			...
			this.panelMainContainer.Size = new System.Drawing.Size(930, 458);
			...
			this.Name = "FormEditLinkTags";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Search Engine Tags";

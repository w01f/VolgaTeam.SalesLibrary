...
namespace SalesDepot.CoreObjects.BusinessClasses
{
	public class LibraryPage : ISyncObject
	{
		...
		{
			LibraryPage page = new LibraryPage(parent);
			page.Name = this.Name;
			page.Enable = this.Enable;
			page.Order = this.Order;
			page.EnableColumnTitles = this.EnableColumnTitles;
			page.ApplyForAllColumnTitles = this.ApplyForAllColumnTitles;
			page.Folders.AddRange(this.Folders.Select(x => x.Clone(page)));
			page.ColumnTitles.AddRange(this.ColumnTitles.Select(x => x.Clone(page)));
			return page;
		}

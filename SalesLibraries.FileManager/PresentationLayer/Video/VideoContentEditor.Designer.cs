namespace SalesLibraries.FileManager.PresentationLayer.Video
{
	partial class VideoContentEditor
	{
		...
		private void InitializeComponent()
		{
			...
			this.gridColumnVideoCrf = new DevExpress.XtraGrid.Columns.GridColumn();
			this.repositoryItemComboBoxCrfEnabled = new DevExpress.XtraEditors.Repository.RepositoryItemComboBox();
			...
			((System.ComponentModel.ISupportInitialize)(this.repositoryItemComboBoxCrfEnabled)).BeginInit();
			...
			this.gridViewVideo.OptionsMenu.EnableColumnMenu = false;
			this.gridViewVideo.OptionsMenu.EnableFooterMenu = false;
			this.gridViewVideo.OptionsMenu.EnableGroupPanelMenu = false;
			this.gridViewVideo.OptionsMenu.ShowAutoFilterRowItem = false;
			this.gridViewVideo.OptionsMenu.ShowDateTimeGroupIntervalItems = false;
			this.gridViewVideo.OptionsMenu.ShowGroupSortSummaryItems = false;
			this.gridViewVideo.OptionsMenu.ShowSplitItem = false;
			...
			this.gridViewVideo.PopupMenuShowing += new DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventHandler(this.gridViewVideo_PopupMenuShowing);
			this.gridViewVideo.ShowingEditor += new System.ComponentModel.CancelEventHandler(this.OnGridViewVideoShowingEditor);
			this.gridViewVideo.CellValueChanged += new DevExpress.XtraGrid.Views.Base.CellValueChangedEventHandler(this.OnGridViewVideoCellValueChanged);
			// 
			...
			this.gridColumnVideoSelected.OptionsColumn.AllowSize = false;
			...
			this.gridColumnVideoIndex.OptionsColumn.AllowSize = false;
			...
			this.gridColumnVideoSourceFileInfo.Width = 300;
			// 
			...
			// gridColumnVideoCrf
			// 
			this.gridColumnVideoCrf.AppearanceCell.Options.UseTextOptions = true;
			this.gridColumnVideoCrf.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gridColumnVideoCrf.Caption = "CRF";
			this.gridColumnVideoCrf.ColumnEdit = this.repositoryItemComboBoxCrfEnabled;
			this.gridColumnVideoCrf.FieldName = "Crf";
			...
			// 
			this.repositoryItemComboBoxCrfEnabled.Appearance.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.repositoryItemComboBoxCrfEnabled.Appearance.Options.UseFont = true;
			this.repositoryItemComboBoxCrfEnabled.Appearance.Options.UseTextOptions = true;
			this.repositoryItemComboBoxCrfEnabled.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.repositoryItemComboBoxCrfEnabled.AppearanceDisabled.Font = new System.Drawing.Font("Arial", 9.75F);
			this.repositoryItemComboBoxCrfEnabled.AppearanceDisabled.Options.UseFont = true;
			this.repositoryItemComboBoxCrfEnabled.AppearanceDisabled.Options.UseTextOptions = true;
			this.repositoryItemComboBoxCrfEnabled.AppearanceDisabled.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.repositoryItemComboBoxCrfEnabled.AppearanceDropDown.Font = new System.Drawing.Font("Arial", 9.75F);
			this.repositoryItemComboBoxCrfEnabled.AppearanceDropDown.Options.UseFont = true;
			this.repositoryItemComboBoxCrfEnabled.AppearanceFocused.Font = new System.Drawing.Font("Arial", 9.75F);
			this.repositoryItemComboBoxCrfEnabled.AppearanceFocused.Options.UseFont = true;
			this.repositoryItemComboBoxCrfEnabled.AppearanceFocused.Options.UseTextOptions = true;
			this.repositoryItemComboBoxCrfEnabled.AppearanceFocused.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.repositoryItemComboBoxCrfEnabled.AppearanceReadOnly.Font = new System.Drawing.Font("Arial", 9.75F);
			this.repositoryItemComboBoxCrfEnabled.AppearanceReadOnly.Options.UseFont = true;
			this.repositoryItemComboBoxCrfEnabled.AppearanceReadOnly.Options.UseTextOptions = true;
			this.repositoryItemComboBoxCrfEnabled.AppearanceReadOnly.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.repositoryItemComboBoxCrfEnabled.AutoHeight = false;
			this.repositoryItemComboBoxCrfEnabled.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repositoryItemComboBoxCrfEnabled.DropDownRows = 4;
			this.repositoryItemComboBoxCrfEnabled.Items.AddRange(new object[] {
            "none",
            "24",
            "29",
            "35"});
			this.repositoryItemComboBoxCrfEnabled.Name = "repositoryItemComboBoxCrfEnabled";
			this.repositoryItemComboBoxCrfEnabled.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
			this.repositoryItemComboBoxCrfEnabled.Closed += new DevExpress.XtraEditors.Controls.ClosedEventHandler(this.repositoryItemComboBoxCrfEnabled_Closed);
			// 
			// gridColumnVideoMp4FileInfo
			// 
			this.gridColumnVideoMp4FileInfo.AppearanceCell.Options.UseTextOptions = true;
			this.gridColumnVideoMp4FileInfo.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gridColumnVideoMp4FileInfo.Caption = "MP4";
			...
			this.gridColumnVideoMp4FileInfo.OptionsColumn.AllowSize = false;
			this.gridColumnVideoMp4FileInfo.OptionsColumn.FixedWidth = true;
			...
			this.gridColumnVideoWidth.Caption = "W";
			...
			this.gridColumnVideoWidth.OptionsColumn.AllowSize = false;
			...
			this.gridColumnVideoHeight.Caption = "H";
			...
			this.gridColumnVideoHeight.OptionsColumn.AllowSize = false;
			...
			this.gridColumnVideoLength.Caption = "Lgth";
			...
			this.gridColumnVideoLength.OptionsColumn.AllowSize = false;
			...
			// 
			// repositoryItemTextEditCrfDisabled
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.repositoryItemComboBoxCrfEnabled)).EndInit();
		...
		private DevComponents.DotNetBar.ButtonX buttonXSelectMissing;
		private DevExpress.XtraEditors.CheckEdit checkEditUseConvertSettingsForAllVideo;
		private DevExpress.XtraEditors.StyleController styleController;
		private DevExpress.XtraEditors.ComboBoxEdit comboBoxEditCrf;
		private DevExpress.XtraGrid.Columns.GridColumn gridColumnVideoCrf;
		private DevExpress.XtraEditors.Repository.RepositoryItemComboBox repositoryItemComboBoxCrfEnabled;

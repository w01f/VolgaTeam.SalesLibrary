...
{
    partial class FormCalendarSettings
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.laCalendarBackColor = new System.Windows.Forms.Label();
			this.buttonXOK = new DevComponents.DotNetBar.ButtonX();
			this.buttonXCancel = new DevComponents.DotNetBar.ButtonX();
			this.styleController = new DevExpress.XtraEditors.StyleController(this.components);
			this.colorEditCalendarBackColor = new DevExpress.XtraEditors.ColorEdit();
			this.colorEditCalendarBorderColor = new DevExpress.XtraEditors.ColorEdit();
			this.laCalendarBorderColor = new System.Windows.Forms.Label();
			this.colorEditCalendarHeaderBackColor = new DevExpress.XtraEditors.ColorEdit();
			this.laCalendarHeaderColor = new System.Windows.Forms.Label();
			this.colorEditCalendarHeaderForeColor = new DevExpress.XtraEditors.ColorEdit();
			this.laCalendarHeaderForeColor = new System.Windows.Forms.Label();
			this.colorEditMonthHeaderForeColor = new DevExpress.XtraEditors.ColorEdit();
			this.laMonthHeaderForeColor = new System.Windows.Forms.Label();
			this.colorEditMonthHeaderBackColor = new DevExpress.XtraEditors.ColorEdit();
			this.laMonthHeaderBackColor = new System.Windows.Forms.Label();
			this.colorEditMonthBodyForeColor = new DevExpress.XtraEditors.ColorEdit();
			this.laMonthBodyForeColor = new System.Windows.Forms.Label();
			this.colorEditMonthBodyBackColor = new DevExpress.XtraEditors.ColorEdit();
			this.laMonthBodyBackColor = new System.Windows.Forms.Label();
			this.colorEditSweepForeColor = new DevExpress.XtraEditors.ColorEdit();
			this.laSweepForeColor = new System.Windows.Forms.Label();
			this.colorEditSweepBackColor = new DevExpress.XtraEditors.ColorEdit();
			this.laSweepBackColor = new System.Windows.Forms.Label();
			this.colorEditDeadLinksForeColor = new DevExpress.XtraEditors.ColorEdit();
			this.laDeadLinksForeColor = new System.Windows.Forms.Label();
			this.buttonXResetColors = new DevComponents.DotNetBar.ButtonX();
			((System.ComponentModel.ISupportInitialize)(this.styleController)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditCalendarBackColor.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditCalendarBorderColor.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditCalendarHeaderBackColor.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditCalendarHeaderForeColor.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditMonthHeaderForeColor.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditMonthHeaderBackColor.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditMonthBodyForeColor.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditMonthBodyBackColor.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditSweepForeColor.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditSweepBackColor.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditDeadLinksForeColor.Properties)).BeginInit();
			this.SuspendLayout();
			// 
			// laCalendarBackColor
			// 
			...
			this.laCalendarBackColor.TabIndex = 0;
			this.laCalendarBackColor.Text = "Background Color:";
			// 
			// buttonXOK
			// 
			...
			this.buttonXOK.Location = new System.Drawing.Point(43, 459);
			...
			this.buttonXCancel.Location = new System.Drawing.Point(180, 459);
			...
			this.laCalendarBorderColor.TabIndex = 26;
			this.laCalendarBorderColor.Text = "Border Color:";
			// 
			// colorEditCalendarHeaderBackColor
			// 
			...
			this.laCalendarHeaderColor.TabIndex = 28;
			this.laCalendarHeaderColor.Text = "Calendar Header Back Color:";
			// 
			// colorEditCalendarHeaderForeColor
			// 
			...
			this.laCalendarHeaderForeColor.TabIndex = 30;
			this.laCalendarHeaderForeColor.Text = "Calendar Header Font Color:";
			// 
			// colorEditMonthHeaderForeColor
			// 
			...
			this.laMonthHeaderForeColor.TabIndex = 34;
			this.laMonthHeaderForeColor.Text = "Month Title Font Color:";
			// 
			// colorEditMonthHeaderBackColor
			// 
			...
			this.laMonthHeaderBackColor.TabIndex = 32;
			this.laMonthHeaderBackColor.Text = "Month Title Back Color:";
			// 
			// colorEditMonthBodyForeColor
			// 
			...
			this.laMonthBodyForeColor.TabIndex = 38;
			this.laMonthBodyForeColor.Text = "Month Days Font Color:";
			// 
			// colorEditMonthBodyBackColor
			// 
			...
			this.laMonthBodyBackColor.TabIndex = 36;
			this.laMonthBodyBackColor.Text = "Month Days Back Color:";
			// 
			// colorEditSweepForeColor
			// 
			...
			this.laSweepForeColor.TabIndex = 42;
			this.laSweepForeColor.Text = "Sweeps Font Color:";
			// 
			// colorEditSweepBackColor
			// 
			...
			this.laSweepBackColor.TabIndex = 40;
			this.laSweepBackColor.Text = "Sweeps Shade Color:";
			// 
			// colorEditDeadLinksForeColor
			// 
			...
			this.laDeadLinksForeColor.TabIndex = 44;
			this.laDeadLinksForeColor.Text = "Dead Days Font Color:";
			// 
			// buttonXResetColors
			// 
			this.buttonXResetColors.AccessibleRole = System.Windows.Forms.AccessibleRole.PushButton;
			this.buttonXResetColors.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.buttonXResetColors.ColorTable = DevComponents.DotNetBar.eButtonColor.OrangeWithBackground;
			this.buttonXResetColors.Location = new System.Drawing.Point(15, 412);
			this.buttonXResetColors.Name = "buttonXResetColors";
			this.buttonXResetColors.Size = new System.Drawing.Size(289, 26);
			this.buttonXResetColors.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
			this.buttonXResetColors.TabIndex = 46;
			this.buttonXResetColors.Text = "Reset to Defaults";
			this.buttonXResetColors.TextColor = System.Drawing.Color.Black;
			this.buttonXResetColors.Click += new System.EventHandler(this.buttonXResetColors_Click);
			// 
			// FormCalendarSettings
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.BackColor = System.Drawing.Color.White;
			this.ClientSize = new System.Drawing.Size(316, 498);
			this.Controls.Add(this.buttonXResetColors);
			this.Controls.Add(this.colorEditDeadLinksForeColor);
			this.Controls.Add(this.laDeadLinksForeColor);
			this.Controls.Add(this.colorEditSweepForeColor);
			this.Controls.Add(this.laSweepForeColor);
			this.Controls.Add(this.colorEditSweepBackColor);
			this.Controls.Add(this.laSweepBackColor);
			this.Controls.Add(this.colorEditMonthBodyForeColor);
			this.Controls.Add(this.laMonthBodyForeColor);
			this.Controls.Add(this.colorEditMonthBodyBackColor);
			this.Controls.Add(this.laMonthBodyBackColor);
			this.Controls.Add(this.colorEditMonthHeaderForeColor);
			this.Controls.Add(this.laMonthHeaderForeColor);
			this.Controls.Add(this.colorEditMonthHeaderBackColor);
			this.Controls.Add(this.laMonthHeaderBackColor);
			this.Controls.Add(this.colorEditCalendarHeaderForeColor);
			this.Controls.Add(this.laCalendarHeaderForeColor);
			this.Controls.Add(this.colorEditCalendarHeaderBackColor);
			this.Controls.Add(this.laCalendarHeaderColor);
			this.Controls.Add(this.colorEditCalendarBorderColor);
			this.Controls.Add(this.laCalendarBorderColor);
			this.Controls.Add(this.colorEditCalendarBackColor);
			...
			this.Name = "FormCalendarSettings";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Overnights Calendar Settings";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.Form_FormClosing);
			this.Load += new System.EventHandler(this.FormCalendarSettings_Load);
			((System.ComponentModel.ISupportInitialize)(this.styleController)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditCalendarBackColor.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditCalendarBorderColor.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditCalendarHeaderBackColor.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditCalendarHeaderForeColor.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditMonthHeaderForeColor.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditMonthHeaderBackColor.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditMonthBodyForeColor.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditMonthBodyBackColor.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditSweepForeColor.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditSweepBackColor.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.colorEditDeadLinksForeColor.Properties)).EndInit();
        ...
        private System.Windows.Forms.Label laCalendarBackColor;
        private DevComponents.DotNetBar.ButtonX buttonXOK;
        private DevComponents.DotNetBar.ButtonX buttonXCancel;
		private DevExpress.XtraEditors.StyleController styleController;
        private DevExpress.XtraEditors.ColorEdit colorEditCalendarBackColor;
        private DevExpress.XtraEditors.ColorEdit colorEditCalendarBorderColor;
        private System.Windows.Forms.Label laCalendarBorderColor;
        private DevExpress.XtraEditors.ColorEdit colorEditCalendarHeaderBackColor;
        private System.Windows.Forms.Label laCalendarHeaderColor;
        private DevExpress.XtraEditors.ColorEdit colorEditCalendarHeaderForeColor;
        private System.Windows.Forms.Label laCalendarHeaderForeColor;
        private DevExpress.XtraEditors.ColorEdit colorEditMonthHeaderForeColor;
        private System.Windows.Forms.Label laMonthHeaderForeColor;
        private DevExpress.XtraEditors.ColorEdit colorEditMonthHeaderBackColor;
        private System.Windows.Forms.Label laMonthHeaderBackColor;
        private DevExpress.XtraEditors.ColorEdit colorEditMonthBodyForeColor;
        private System.Windows.Forms.Label laMonthBodyForeColor;
        private DevExpress.XtraEditors.ColorEdit colorEditMonthBodyBackColor;
        private System.Windows.Forms.Label laMonthBodyBackColor;
        private DevExpress.XtraEditors.ColorEdit colorEditSweepForeColor;
        private System.Windows.Forms.Label laSweepForeColor;
        private DevExpress.XtraEditors.ColorEdit colorEditSweepBackColor;
        private System.Windows.Forms.Label laSweepBackColor;
        private DevExpress.XtraEditors.ColorEdit colorEditDeadLinksForeColor;
        private System.Windows.Forms.Label laDeadLinksForeColor;
        private DevComponents.DotNetBar.ButtonX buttonXResetColors;
    }
}
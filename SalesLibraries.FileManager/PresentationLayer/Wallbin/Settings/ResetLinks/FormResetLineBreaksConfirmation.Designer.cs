...
{
	partial class FormResetLineBreaksConfirmation
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.labelControlTitle.Text = "<b>Are you SURE you want to reset the following line-break properties?</b><br><co" +
    "lor=gray>({0})</color>";
			// 
			// layoutControl
			// 
			...
			// 
			// FormResetLineBreaksConfirmation
			// 
			...
			this.Name = "FormResetLineBreaksConfirmation";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Reset Line-Breaks";

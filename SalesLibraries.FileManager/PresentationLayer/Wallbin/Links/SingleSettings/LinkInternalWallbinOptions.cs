...
namespace SalesLibraries.FileManager.PresentationLayer.Wallbin.Links.SingleSettings
{
	...
	{
		private InternalWallbinLink _data;
		...
		public LinkInternalWallbinOptions()
		{
			InitializeComponent();
			Text = "Admin";
		...
		public LinkInternalWallbinOptions(FileTypes? defaultLinkType = null) : this() { }

		public void LoadData(BaseLibraryLink sourceLink)
		{
			_data = (InternalWallbinLink)sourceLink;

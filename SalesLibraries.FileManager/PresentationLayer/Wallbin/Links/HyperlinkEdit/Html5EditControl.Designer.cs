...
{
	partial class Html5EditControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.labelControllTitle.Text = "<color=gray><i>Add HTML5 PowerPoint link…</i></color>";
			// 
			// styleController
			// 
			...
			this.checkEditBlueHyperlink.TabIndex = 37;
			// 
			...
			this.checkEditForcePreview.TabIndex = 38;
			// 
			// checkEditBold
			// 
			...
			this.checkEditBold.TabIndex = 39;
			// 
			// Html5EditControl
			// 

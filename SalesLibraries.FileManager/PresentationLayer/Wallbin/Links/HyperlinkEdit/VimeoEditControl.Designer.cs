...
{
	partial class VimeoEditControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.layoutControlItemPath.Text = "Specific Vimeo URL";
			this.layoutControlItemPath.TextLocation = DevExpress.Utils.Locations.Top;
			this.layoutControlItemPath.TextSize = new System.Drawing.Size(116, 16);

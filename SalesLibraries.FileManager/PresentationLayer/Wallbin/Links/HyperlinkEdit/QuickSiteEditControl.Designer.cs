...
{
	partial class QuickSiteEditControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.labelControllTitle.Text = "<color=gray><i>Add a link to a QuickSite url…</i></color>";
			// 
			// styleController
			// 
			...
			this.laPath.Size = new System.Drawing.Size(94, 16);
			this.laPath.TabIndex = 33;
			this.laPath.Text = "QuickSite URL";
			// 
			// laName
			// 
			...
			this.checkEditForcePreview.Properties.Caption = "<b>Immediately open this QuickSite when clicked</b>";

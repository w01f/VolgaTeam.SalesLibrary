namespace SalesLibraries.FileManager.PresentationLayer.Wallbin.Links.HyperlinkEdit
{
	partial class InternalWallbinLinkEditControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.laSelectorType = new System.Windows.Forms.Label();
			...
			this.comboBoxEditSelectorType = new DevExpress.XtraEditors.ComboBoxEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.comboBoxEditSelectorType.Properties)).BeginInit();
			this.SuspendLayout();
			// 
			// styleController
			// 
			...
			// laSelectorType
			// 
			this.laSelectorType.AutoSize = true;
			this.laSelectorType.BackColor = System.Drawing.Color.White;
			this.laSelectorType.ForeColor = System.Drawing.Color.Black;
			this.laSelectorType.Location = new System.Drawing.Point(305, 114);
			this.laSelectorType.Name = "laSelectorType";
			this.laSelectorType.Size = new System.Drawing.Size(121, 16);
			this.laSelectorType.TabIndex = 50;
			this.laSelectorType.Text = "Page Selector Type";
			// 
			// checkEditShowLogo
			// 
			this.checkEditShowLogo.EditValue = true;
			this.checkEditShowLogo.Location = new System.Drawing.Point(17, 149);
			...
			// 
			// comboBoxEditSelectorType
			// 
			this.comboBoxEditSelectorType.EditValue = "Tabs";
			this.comboBoxEditSelectorType.Location = new System.Drawing.Point(454, 111);
			this.comboBoxEditSelectorType.Name = "comboBoxEditSelectorType";
			this.comboBoxEditSelectorType.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.comboBoxEditSelectorType.Properties.Items.AddRange(new object[] {
            "Tabs",
            "Dropdown"});
			this.comboBoxEditSelectorType.Properties.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
			this.comboBoxEditSelectorType.Size = new System.Drawing.Size(103, 22);
			this.comboBoxEditSelectorType.StyleController = this.styleController;
			this.comboBoxEditSelectorType.TabIndex = 63;
			// 
			// InternalWallbinLinkEditControl
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.BackColor = System.Drawing.Color.White;
			this.Controls.Add(this.comboBoxEditSelectorType);
			...
			this.Controls.Add(this.laSelectorType);
			...
			((System.ComponentModel.ISupportInitialize)(this.comboBoxEditSelectorType.Properties)).EndInit();
		...
		private System.Windows.Forms.Label laSelectorType;
		...
		private DevExpress.XtraEditors.ComboBoxEdit comboBoxEditSelectorType;
	}
}

...
{
	public partial class VimeoEditControl : UserControl, IHyperLinkEditControl
	{
		public VimeoEditControl()
		{
			InitializeComponent();
			Dock = DockStyle.Fill;
		}
		...
		{
			var linkInfo = (VimeoLinkInfo)PrepareHyperLinkInfo();

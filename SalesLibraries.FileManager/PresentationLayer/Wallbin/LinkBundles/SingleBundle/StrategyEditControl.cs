...
{
	[IntendForClass(typeof(StrategyItem))]
	//public partial class StrategyEditControl : UserControl, ILinkBundleInfoEditControl
	public partial class StrategyEditControl : XtraTabPage, ILinkBundleInfoEditControl
	{
		private StrategyItem _bundleItem;

		public StrategyEditControl(StrategyItem bundleItem)
		{

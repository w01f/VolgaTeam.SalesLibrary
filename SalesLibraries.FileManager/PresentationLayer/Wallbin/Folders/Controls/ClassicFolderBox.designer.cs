namespace SalesLibraries.FileManager.PresentationLayer.Wallbin.Folders.Controls
{
	partial class ClassicFolderBox
	{
		...
		protected override void InitializeComponent()
		{
			...
			this.barButtonItemMultiLinkPropertiesThumbnail = new DevExpress.XtraBars.BarButtonItem();
			...
			this.barButtonItemFolderPropertiesMultiLinksThumbnail = new DevExpress.XtraBars.BarButtonItem();
			...
			// labelControlText
			// 
			this.labelControlText.Appearance.Options.UseTextOptions = true;
            ...
            new DevExpress.XtraBars.LinkPersistInfo(this.barSubItemSingleLinkPropertiesOneDrive, true),
			...
			this.barButtonItemSingleLinkPropertiesCopy.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnSingleLinkPropertiesCopyClick);
			// 
			...
			this.barButtonItemSingleLinkPropertiesCut.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnSingleLinkPropertiesCutClick);
			// 
			...
			this.barButtonItemSingleLinkPropertiesPaste.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnSingleLinkPropertiesPasteClick);
			// 
			...
			this.barSubItemSingleLinkPropertiesAddHyperlinkUrl.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnSingleLinkPropertiesAddHyperlinkUrlClick);
			// 
			...
			this.barSubItemSingleLinkPropertiesAddHyperlinkYouTube.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnSingleLinkPropertiesAddHyperlinkYouTubeClick);
			// 
			...
			this.barSubItemSingleLinkPropertiesAddHyperlinkVimeo.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnSingleLinkPropertiesAddHyperlinkVimeoClick);
			// 
			...
			this.barSubItemSingleLinkPropertiesAddHyperlinkQuickSite.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnSingleLinkPropertiesAddHyperlinkQuickSiteClick);
			// 
			...
			this.barSubItemSingleLinkPropertiesAddHyperlinkHtml5.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnSingleLinkPropertiesAddHyperlinkHtml5Click);
			// 
			...
			this.barSubItemSingleLinkPropertiesAddHyperlinkInternal.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnSingleLinkPropertiesAddHyperlinkInternalClick);
			// 
			...
			this.barSubItemSingleLinkPropertiesAddHyperlinkLan.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnSingleLinkPropertiesAddHyperlinkLanClick);
			// 
			...
			this.barSubItemSingleLinkPropertiesAddHyperlinkApp.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnSingleLinkPropertiesAddHyperlinkAppClick);
			// 
			...
			this.barButtonItemSingleLinkPropertiesImageSettings.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnSingleLinkPropertiesEditImageSettingsClick);
			// 
			// barSubItemSingleLinkPropertiesOpenLink
			// 
			this.barSubItemSingleLinkPropertiesOpenLink.Caption = "Open";
			this.barSubItemSingleLinkPropertiesOpenLink.Id = 113;
			...
			this.barButtonItemSingleLinkPropertiesOpenLinkSiteLink.Id = 115;
			...
			this.barButtonItemSingleLinkPropertiesOpenLinkOneDriveLink.Id = 116;
            ...
            this.barButtonItemMultiLinkPropertiesThumbnail,
            this.barButtonItemFolderPropertiesMultiLinksThumbnail,
			...
			// 
			// barButtonItemFolderPropertiesFolderSettings
			// 
			this.barButtonItemFolderPropertiesFolderSettings.Caption = "Edit Window Settings";
			this.barButtonItemFolderPropertiesFolderSettings.CategoryGuid = new System.Guid("3a966d5d-4343-449c-8447-c9c627653e09");
			this.barButtonItemFolderPropertiesFolderSettings.Id = 38;
			...
			this.barButtonItemFolderPropertiesDeleteFolder.CategoryGuid = new System.Guid("3a966d5d-4343-449c-8447-c9c627653e09");
			this.barButtonItemFolderPropertiesDeleteFolder.Id = 40;
			this.barButtonItemFolderPropertiesDeleteFolder.Name = "barButtonItemFolderPropertiesDeleteFolder";
			this.barButtonItemFolderPropertiesDeleteFolder.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemFolderPropertiesDeleteFolder_ItemClick);
			// 
			// barSubItemFolderPropertiesFolderCopy
			// 
			this.barSubItemFolderPropertiesFolderCopy.Caption = "Copy this Window to a page…";
			this.barSubItemFolderPropertiesFolderCopy.CategoryGuid = new System.Guid("3a966d5d-4343-449c-8447-c9c627653e09");
			this.barSubItemFolderPropertiesFolderCopy.Id = 42;
			this.barSubItemFolderPropertiesFolderCopy.Name = "barSubItemFolderPropertiesFolderCopy";
			// 
			// barSubItemFolderPropertiesFolderMove
			// 
			this.barSubItemFolderPropertiesFolderMove.Caption = "Move this Window to a page…";
			...
			// 
			this.barSubItemFolderPropertiesWidgetsAndBanners.Caption = "Window Title Artwork";
			this.barSubItemFolderPropertiesWidgetsAndBanners.CategoryGuid = new System.Guid("3a966d5d-4343-449c-8447-c9c627653e09");
			this.barSubItemFolderPropertiesWidgetsAndBanners.Id = 46;
			this.barSubItemFolderPropertiesWidgetsAndBanners.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] {
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItemFolderPropertiesFolderWidget),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItemFolderPropertiesFolderBanner)});
			this.barSubItemFolderPropertiesWidgetsAndBanners.Name = "barSubItemFolderPropertiesWidgetsAndBanners";
			// 
			// barButtonItemFolderPropertiesFolderWidget
			// 
			this.barButtonItemFolderPropertiesFolderWidget.Caption = "Widget Icon (tiny)";
			this.barButtonItemFolderPropertiesFolderWidget.CategoryGuid = new System.Guid("3a966d5d-4343-449c-8447-c9c627653e09");
			this.barButtonItemFolderPropertiesFolderWidget.Id = 47;
			this.barButtonItemFolderPropertiesFolderWidget.Name = "barButtonItemFolderPropertiesFolderWidget";
			this.barButtonItemFolderPropertiesFolderWidget.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemFolderPropertiesFolderWidget_ItemClick);
			// 
			// barButtonItemFolderPropertiesFolderBanner
			// 
			this.barButtonItemFolderPropertiesFolderBanner.Caption = "Clipart Logo (BIG)";
			this.barButtonItemFolderPropertiesFolderBanner.CategoryGuid = new System.Guid("3a966d5d-4343-449c-8447-c9c627653e09");
			this.barButtonItemFolderPropertiesFolderBanner.Id = 48;
			this.barButtonItemFolderPropertiesFolderBanner.Name = "barButtonItemFolderPropertiesFolderBanner";
			this.barButtonItemFolderPropertiesFolderBanner.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemFolderPropertiesFolderBanner_ItemClick);
			// 
			// barButtonItemFolderPropertiesDeleteLinkWidgets
			// 
			this.barButtonItemFolderPropertiesDeleteLinkWidgets.Caption = "Delete all Widget Icons in this Window";
			this.barButtonItemFolderPropertiesDeleteLinkWidgets.CategoryGuid = new System.Guid("3a966d5d-4343-449c-8447-c9c627653e09");
			this.barButtonItemFolderPropertiesDeleteLinkWidgets.Id = 49;
			this.barButtonItemFolderPropertiesDeleteLinkWidgets.Name = "barButtonItemFolderPropertiesDeleteLinkWidgets";
			this.barButtonItemFolderPropertiesDeleteLinkWidgets.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemFolderPropertiesDeleteLinkWidgets_ItemClick);
			// 
			// barButtonItemFolderPropertiesDeleteLinkBanners
			// 
			this.barButtonItemFolderPropertiesDeleteLinkBanners.Caption = "Delete all Clipart Images in this Window";
			this.barButtonItemFolderPropertiesDeleteLinkBanners.CategoryGuid = new System.Guid("3a966d5d-4343-449c-8447-c9c627653e09");
			...
			// 
			this.barSubItemFolderPropertiesTools.Caption = "Advanced Window Cleanup Tools";
			this.barSubItemFolderPropertiesTools.CategoryGuid = new System.Guid("3a966d5d-4343-449c-8447-c9c627653e09");
			this.barSubItemFolderPropertiesTools.Id = 52;
			this.barSubItemFolderPropertiesTools.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] {
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItemFolderPropertiesDeleteLinkSecurity),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItemFolderPropertiesDeleteLinkTags),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItemFolderPropertiesDeleteLinkWidgets),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItemFolderPropertiesDeleteLinkBanners),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItemFolderPropertiesSortLinks),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItemFolderPropertiesSetLinkTextWordWrap)});
			this.barSubItemFolderPropertiesTools.Name = "barSubItemFolderPropertiesTools";
			// 
			// barButtonItemFolderPropertiesDeleteLinkSecurity
			// 
			this.barButtonItemFolderPropertiesDeleteLinkSecurity.Caption = "Delete Security Settings for ALL Links in this window";
			this.barButtonItemFolderPropertiesDeleteLinkSecurity.CategoryGuid = new System.Guid("3a966d5d-4343-449c-8447-c9c627653e09");
			this.barButtonItemFolderPropertiesDeleteLinkSecurity.Id = 53;
			this.barButtonItemFolderPropertiesDeleteLinkSecurity.Name = "barButtonItemFolderPropertiesDeleteLinkSecurity";
			this.barButtonItemFolderPropertiesDeleteLinkSecurity.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemFolderPropertiesDeleteLinkSecurity_ItemClick);
			// 
			// barButtonItemFolderPropertiesDeleteLinkTags
			// 
			this.barButtonItemFolderPropertiesDeleteLinkTags.Caption = "Wipe ALL Tags for ALL Links in this window";
			this.barButtonItemFolderPropertiesDeleteLinkTags.CategoryGuid = new System.Guid("3a966d5d-4343-449c-8447-c9c627653e09");
			this.barButtonItemFolderPropertiesDeleteLinkTags.Id = 54;
			this.barButtonItemFolderPropertiesDeleteLinkTags.Name = "barButtonItemFolderPropertiesDeleteLinkTags";
			this.barButtonItemFolderPropertiesDeleteLinkTags.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemFolderPropertiesDeleteLinkTags_ItemClick);
			// 
			// barButtonItemFolderPropertiesSortLinks
			// 
			this.barButtonItemFolderPropertiesSortLinks.Caption = "Sort Links in this Window A-Z";
			this.barButtonItemFolderPropertiesSortLinks.CategoryGuid = new System.Guid("3a966d5d-4343-449c-8447-c9c627653e09");
			this.barButtonItemFolderPropertiesSortLinks.Id = 55;
			this.barButtonItemFolderPropertiesSortLinks.Name = "barButtonItemFolderPropertiesSortLinks";
			this.barButtonItemFolderPropertiesSortLinks.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemFolderPropertiesSortLinks_ItemClick);
			// 
			// barButtonItemFolderPropertiesSetLinkTextWordWrap
			// 
			this.barButtonItemFolderPropertiesSetLinkTextWordWrap.Caption = "Make all Links RESPONSIVE";
			this.barButtonItemFolderPropertiesSetLinkTextWordWrap.CategoryGuid = new System.Guid("3a966d5d-4343-449c-8447-c9c627653e09");
			this.barButtonItemFolderPropertiesSetLinkTextWordWrap.Id = 56;
			this.barButtonItemFolderPropertiesSetLinkTextWordWrap.Name = "barButtonItemFolderPropertiesSetLinkTextWordWrap";
			this.barButtonItemFolderPropertiesSetLinkTextWordWrap.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemFolderPropertiesSetLinkTextWordWrap_ItemClick);
			// 
            ...
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItemMultiLinkPropertiesThumbnail)});
			...
			// 
			// barButtonItemMultiLinkPropertiesThumbnail
			// 
			this.barButtonItemMultiLinkPropertiesThumbnail.Caption = "Thumbnail";
			this.barButtonItemMultiLinkPropertiesThumbnail.CategoryGuid = new System.Guid("6c8e0da8-e302-4333-8e7e-3f6d0d1f60db");
			this.barButtonItemMultiLinkPropertiesThumbnail.Id = 111;
			this.barButtonItemMultiLinkPropertiesThumbnail.Name = "barButtonItemMultiLinkPropertiesThumbnail";
			this.barButtonItemMultiLinkPropertiesThumbnail.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemMultiLinkPropertiesThumbnail_ItemClick);
			// 
            ...
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItemFolderPropertiesMultiLinksThumbnail)});
			...
			// 
			// barButtonItemFolderPropertiesMultiLinksThumbnail
			// 
			this.barButtonItemFolderPropertiesMultiLinksThumbnail.Caption = "Thumbnail";
			this.barButtonItemFolderPropertiesMultiLinksThumbnail.Id = 112;
			this.barButtonItemFolderPropertiesMultiLinksThumbnail.Name = "barButtonItemFolderPropertiesMultiLinksThumbnail";
			this.barButtonItemFolderPropertiesMultiLinksThumbnail.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemFolderPropertiesMultiLinksThumbnail_ItemClick);
			// 
			...
			this.popupMenuFolderProperties.BeforePopup += new System.ComponentModel.CancelEventHandler(this.popupMenuFolderProperties_BeforePopup);
			// 
		...
		private DevExpress.XtraBars.BarButtonItem barButtonItemFolderPropertiesSortLinks;
		...
		private DevExpress.XtraBars.BarButtonItem barButtonItemMultiLinkPropertiesThumbnail;
		private DevExpress.XtraBars.BarButtonItem barButtonItemFolderPropertiesMultiLinksThumbnail;
		...
		private DevExpress.XtraBars.BarSubItem barSubItemSingleLinkPropertiesOneDrive;

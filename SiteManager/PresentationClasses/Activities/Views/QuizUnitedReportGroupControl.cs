...
namespace SalesDepot.SiteManager.PresentationClasses.Activities.Views
{
	...
	public partial class QuizUnitedReportGroupControl : XtraTabPage
	{
		public List<QuizPassUserReportRecord> Records { get; private set; }
		private readonly int _quizCount;

		public QuizUnitedReportGroupControl(IEnumerable<QuizPassUserReportRecord> records, int quizCount)
		{
			InitializeComponent();

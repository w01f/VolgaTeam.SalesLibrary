...
{
	public partial class QuizPassUserReportControl
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(QuizPassUserReportControl));
			...
			this.gridColumnQuizPassDate = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			...
			this.gridColumnQuizTryCount = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
            ...
            this.gridColumnQuizPassDate,
            this.gridColumnUser,
            this.gridColumnGroup,
            this.gridColumnQuizName,
            this.gridColumnQuizTryCount});
			...
			// gridBandMain
			// 
			this.gridBandMain.Columns.Add(this.gridColumnQuizPassDate);
			...
			this.gridBandMain.Columns.Add(this.gridColumnQuizTryCount);
			this.gridBandMain.MinWidth = 20;
			this.gridBandMain.Name = "gridBandMain";
			this.gridBandMain.Width = 894;
			// 
			// gridColumnQuizPassDate
			// 
			this.gridColumnQuizPassDate.Caption = "Date\\Time";
			this.gridColumnQuizPassDate.ColumnEdit = this.repositoryItemDateEditDate;
			this.gridColumnQuizPassDate.FieldName = "QuizPassDate";
			this.gridColumnQuizPassDate.Name = "gridColumnQuizPassDate";
			this.gridColumnQuizPassDate.OptionsColumn.FixedWidth = true;
			this.gridColumnQuizPassDate.Visible = true;
			this.gridColumnQuizPassDate.Width = 159;
			// 
			...
			// 
			// gridColumnQuizTryCount
			// 
			this.gridColumnQuizTryCount.AppearanceCell.Options.UseTextOptions = true;
			this.gridColumnQuizTryCount.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gridColumnQuizTryCount.Caption = "How many Takes?";
			this.gridColumnQuizTryCount.ColumnEdit = this.repositoryItemSpinEditNumeric;
			this.gridColumnQuizTryCount.FieldName = "quizTryCount";
			this.gridColumnQuizTryCount.Name = "gridColumnQuizTryCount";
			this.gridColumnQuizTryCount.OptionsColumn.FixedWidth = true;
			this.gridColumnQuizTryCount.Visible = true;
			this.gridColumnQuizTryCount.Width = 143;
			// 
			// gridColumnQuizName
			// 
			this.gridColumnQuizName.Caption = "Quiz Passed:";
			...
			this.Name = "QuizPassUserReportControl";
		...
		private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn gridColumnQuizPassDate;
		private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn gridColumnUser;
		private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn gridColumnGroup;
		private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn gridColumnQuizTryCount;

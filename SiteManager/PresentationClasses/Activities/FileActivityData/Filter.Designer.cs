namespace SalesDepot.SiteManager.PresentationClasses.Activities.FileActivityData
{
	partial class Filter
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelControlRecordsTitle = new DevExpress.XtraEditors.LabelControl();
			this.imageComboBoxEditRecords = new DevExpress.XtraEditors.ImageComboBoxEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.imageComboBoxEditRecords.Properties)).BeginInit();
			this.SuspendLayout();
			// 
			...
			this.checkedListBoxControlGroups.Size = new System.Drawing.Size(222, 306);
			...
			// 
			// labelControlRecordsTitle
			// 
			this.labelControlRecordsTitle.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.labelControlRecordsTitle.Location = new System.Drawing.Point(8, 406);
			this.labelControlRecordsTitle.Name = "labelControlRecordsTitle";
			this.labelControlRecordsTitle.Size = new System.Drawing.Size(36, 16);
			this.labelControlRecordsTitle.StyleController = this.styleController;
			this.labelControlRecordsTitle.TabIndex = 19;
			this.labelControlRecordsTitle.Text = "Show:";
			// 
			// imageComboBoxEditRecords
			// 
			this.imageComboBoxEditRecords.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.imageComboBoxEditRecords.EditValue = "0";
			this.imageComboBoxEditRecords.Location = new System.Drawing.Point(69, 403);
			this.imageComboBoxEditRecords.Name = "imageComboBoxEditRecords";
			this.imageComboBoxEditRecords.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.imageComboBoxEditRecords.Properties.Items.AddRange(new DevExpress.XtraEditors.Controls.ImageComboBoxItem[] {
            new DevExpress.XtraEditors.Controls.ImageComboBoxItem("All Records", "0", -1),
            new DevExpress.XtraEditors.Controls.ImageComboBoxItem("Top 10", "10", -1),
            new DevExpress.XtraEditors.Controls.ImageComboBoxItem("Top 25", "25", -1),
            new DevExpress.XtraEditors.Controls.ImageComboBoxItem("Top 50", "50", -1)});
			this.imageComboBoxEditRecords.Size = new System.Drawing.Size(161, 22);
			this.imageComboBoxEditRecords.StyleController = this.styleController;
			this.imageComboBoxEditRecords.TabIndex = 20;
			this.imageComboBoxEditRecords.EditValueChanged += new System.EventHandler(this.imageComboBoxEditRecords_EditValueChanged);
			// 
			// Filter
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.BackColor = System.Drawing.Color.White;
			this.Controls.Add(this.imageComboBoxEditRecords);
			this.Controls.Add(this.labelControlRecordsTitle);
			...
			((System.ComponentModel.ISupportInitialize)(this.imageComboBoxEditRecords.Properties)).EndInit();
		...
		private DevExpress.XtraEditors.LabelControl labelControlRecordsTitle;
		private DevExpress.XtraEditors.ImageComboBoxEdit imageComboBoxEditRecords;
	}
}

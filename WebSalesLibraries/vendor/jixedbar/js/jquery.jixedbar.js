        ...
        jixedbar: new function(options) {
            ...
            this.construct = function() {
                ...
                return this.each(function() {
                    ...
                    if(!($.cookie("mobileDeviceUsed")!= null && $.cookie("mobileDeviceUsed") == "true"))
                    {
                        $("li", obj).hover(
                            function () { // hover in method event
                                ...
                                if (tooltipTitle != null && tooltipTitle != "") { // show a tooltip if it's not empty
                    ...
                    $("li", obj).find("ul").each(function() {
                        $(this).css({
                            "display": "none"
                        }); // hide it! but we're listening to any click event
                    });

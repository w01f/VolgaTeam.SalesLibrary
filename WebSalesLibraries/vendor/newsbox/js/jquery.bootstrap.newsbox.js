...
(function ($, w, d, undefined) {
	...
	var NewsBox = {
			...
			if (panel)
			{
				...
				$(panel).find('.prev').on('click', function (ev) {
					...
					ga('send', {
						...
						page: "Landing Page/carousel/lefttVertical"
					});
					ev.preventDefault();
					self.onPrev();
				});
				...
				$(panel).find('.next').on('click', function (ev) {
					...
					ga('send', {
						...
						title: titleFind,
						location: window.BaseUrl,
						page: "Landing Page/carousel/rightVertical"
					});
		...
		onPrev: function () {
			...
			if (typeof self.options.onPrev === 'function')
			{
				self.options.onPrev();
			}
		},
		...
		onNext: function () {
			...
			if (typeof self.options.onNext === 'function')
			{
				self.options.onNext();
			}
		}

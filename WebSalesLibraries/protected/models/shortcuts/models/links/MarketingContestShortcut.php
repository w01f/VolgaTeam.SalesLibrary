<?
	...
	/**
	 * Class MarketingContestShortcut
	 */
	class MarketingContestShortcut extends PageContentShortcut
	{
		...
		/** @var  \application\models\marketing_contest\models\ArchiveSettings */
		...
		public function __construct($linkRecord, $isPhone, $parameters = null)
		{
			...
			$this->archiveSettings = new \application\models\marketing_contest\models\ArchiveSettings();
		...
		public function loadPageConfig()
		{
			...
			if ($queryResult->length > 0)
				$this->archiveSettings = \application\models\marketing_contest\models\ArchiveSettings::fromXml($xpath, $queryResult->item(0));
		...
		public function getPageData()
		{
			...
			{
				$items = MarketingContestItemRecord::model()->getListItems(MarketingContestItemRecord::ListTypeOwn, $this->id);

<?
	...
	{
		/**
		 * @param LinkFeedSettings $feedSettings
		 * @return LinkFeedItem[]
		 * @throws \Exception
		 */
		public static function queryFeedItems($feedSettings)
		{
			...
			{
				case LinkFeedSettings::FeedTypeTrending:
					/**@var TrendingFeedSettings $feedSettings */
					return self::queryTrendingItems($feedSettings);
				case LinkFeedSettings::FeedTypeSearch:
					/**@var SearchFeedSettings $feedSettings */
					return self::querySearchItems($feedSettings);
				case LinkFeedSettings::FeedTypeSpecificLinks:
					/**@var SpecificLinkFeedSettings $feedSettings */
		...
		/**
		 * @param TrendingFeedSettings $feedSettings
		 * @return LinkFeedItem[]
		 */
		private static function queryTrendingItems($feedSettings)
		{
			...
			foreach ($feedSettings->linkFormats as $linkFormat)
				switch ($linkFormat)
				{
					case LinkFeedSettings::LinkFormatPowerPoint:
					case LinkFeedSettings::LinkFormatVideo:
					case LinkFeedSettings::LinkFormatPdf:
					case LinkFeedSettings::LinkFormatWord:
						$queryFormats[] = $linkFormat;
						break;
					case LinkFeedSettings::LinkFormatDocument:
						$queryFormats[] = implode(',', array(LinkFeedSettings::LinkFormatWord, LinkFeedSettings::LinkFormatPdf));
						break;
				}
		...
		/**
		 * @param SearchFeedSettings $feedSettings
		 * @return LinkFeedItem[]
		 */
			...
			foreach ($feedSettings->linkFormats as $linkFormat)
				switch ($linkFormat)
				{
					...
					case LinkFeedSettings::LinkFormatWord:
						...
						break;
					case LinkFeedSettings::LinkFormatDocument:
						$feedSettings->conditions->fileTypes[] = LinkFeedSettings::LinkFormatWord;
						$feedSettings->conditions->fileTypes[] = LinkFeedSettings::LinkFormatPdf;
						break;
				}
		...
		/**
		 * @param SpecificLinkFeedSettings $feedSettings
		 * @return LinkFeedItem[]
		 */
		private static function querySpecificLinkItems($feedSettings)
		{
			...
			{
				case LinkFeedSettings::ThumbnailModeRandom:
			...
			foreach ($feedSettings->linkFormats as $linkFormat)
				switch ($linkFormat)
				{
					...
					case LinkFeedSettings::LinkFormatWord:
						...
						break;
					case LinkFeedSettings::LinkFormatDocument:
						$queryFormats[] = LinkFeedSettings::LinkFormatWord;
						$queryFormats[] = LinkFeedSettings::LinkFormatPdf;
						break;
				}

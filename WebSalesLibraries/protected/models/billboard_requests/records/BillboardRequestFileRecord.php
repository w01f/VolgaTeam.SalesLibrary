<?
	...
	/**
	 * Class BillboardRequestFileRecord
	 * @property mixed id
	 ...
	 */
	class BillboardRequestFileRecord extends CActiveRecord
	{
		...
		{
			return '{{billboard_request_file}}';
		}

		/**
		 * @param $itemId
		 * @param $fileType
		 * @return \application\models\billboard_requests\models\FileModel[]
		 */
		public function getModels($itemId, $fileType)
		{
			...
			foreach ($fileRecords as $fileRecord)
				$models[] = \application\models\billboard_requests\models\FileModel::fromRecord($fileRecord);
			return $models;
		}
		...
		public function getModel($fileId)
		{
			...
			if (isset($itemRecord))
				return \application\models\billboard_requests\models\FileModel::fromRecord($itemRecord);
			return null;
		}
		...
		public static function cloneFiles($itemId, $sourceItemId)
		{
			...
			/** @var $sourceFileRecords BillboardRequestFileRecord[] */
		...
		{
			/** @var $fileRecord BillboardRequestFileRecord */
		...
		{
			/** @var BillboardRequestFileRecord $fileRecords */
		...
		private static function getMaxItemIndex($itemId, $fileType)
		{
			return Yii::app()->db->createCommand()
				...
				->from('tbl_billboard_request_file')

<?
	 ...
	 */
	class SalesContestFileRecord extends CActiveRecord
	{
		...
		public function getModels($itemId, $fileType)
		{
			...
			foreach ($fileRecords as $fileRecord)
				$models[] = \application\models\sales_contest\models\FileModel::fromRecord($fileRecord);
			return $models;
		}
		...
		public function getModel($fileId)
		{
			...
			if (isset($itemRecord))
				return \application\models\sales_contest\models\FileModel::fromRecord($itemRecord);
			return null;
		}
		...
		public static function cloneFiles($itemId, $sourceItemId)
		{
			...
			/** @var $sourceFileRecords SalesContestFileRecord[] */
		...
		{
			/** @var $fileRecord SalesContestFileRecord */
		...
		{
			/** @var SalesContestFileRecord $fileRecords */

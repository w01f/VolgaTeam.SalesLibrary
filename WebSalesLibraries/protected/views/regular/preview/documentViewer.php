...
<div class="link-viewer<? if ($data->config->enableLogging): ?> logger-form<? endif; ?>" data-log-group="Link"
                ...
                <div class="image-button" title="one drive link">
                    <span class="text-item dropdown">
                        ...
                        <ul class="dropdown-menu" style="left: 0;">
                            ...
                            <li>
                                <a href="mailto:?body=<? echo $data->oneDriveUrl; ?>"
                                   class="log-action one-drive-link-email"
    ...
    <ul class="nav nav-tabs" role="tablist" id="link-viewer-body-tabs">
		...
		<? if ($data->config->allowEmail): ?>
            <li>
                <a class="log-action" href="#link-viewer-tab-email" role="tab" data-toggle="tab"
                   data-log-action="Add to QS">Email</a>
            </li>
		<? endif; ?>
    </ul>
                                        ...
                                        <? if (!$data->singlePage): ?>
                                            <li>
                                                <a href="#" class="log-action download-page"
                                                   data-log-action="Download File">
                                                    Download <? echo $pageItemName; ?> <span

...
<table class="tool-dialog logger-form" data-log-group="Billboard Request" data-log-action="Billboard Request Activity" style="width: 400px">
	<tr class="title-row">
		<td colspan="2">
			<legend><? echo $isCloning ? 'Clone Request!' : 'Add a NEW Request!' ?></legend>
		</td>
	</tr>
	<tr>
		<td colspan="2">

...
<table class="tool-dialog logger-form" data-log-group="StarsSteals" data-log-action="StarsSteals Activity" style="width: 400px">
	<tr class="title-row">
		<td colspan="2">
			<legend><? echo $isCloning ? 'Clone STAR or STEAL!' : 'Add a NEW STAR or STEAL!' ?></legend>
		</td>
	</tr>
	<tr>
		<td colspan="2">

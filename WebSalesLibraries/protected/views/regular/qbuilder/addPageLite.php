<div class="tool-dialog">
	...
	<div class="tabbable">
		<ul id="add-page-tabs" class="nav nav-tabs">
			...
			<li><a href="#add-page-tab-settings" data-toggle="tab">Options</a></li>
			<li><a href="#add-page-tab-security" data-toggle="tab">Security</a></li>
		</ul>
		<div class="tab-content">
			...
			<div id="add-page-tab-settings" class="tab-pane fade">
				<div style="height: 315px;">
					<label class="checkbox"><input id="add-page-show-link-to-main-site" type="checkbox" value="">Show Link to Main Site at top of page</label>
					<br><br>
			...
			<div id="add-page-tab-security" class="tab-pane fade">
				<div style="height: 315px;">

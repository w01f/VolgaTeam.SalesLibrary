<?php
	...
	$cs->registerCssFile(Yii::app()->getBaseUrl(true) . '/css/regular/qpage/page-content.css?' . $version);
	...
	$cs->registerScriptFile(Yii::app()->getBaseUrl(true) . '/js/regular/qpage/page-links.js?' . $version, CClientScript::POS_HEAD);
	$cs->registerScriptFile(Yii::app()->getBaseUrl(true) . '/js/regular/qpage/controller.js?' . $version, CClientScript::POS_HEAD);

...
?>
<div class="sales-requests-main-page">
    <div class="service-panel left logger-form" data-log-group="Sales Request" data-log-action="Sales Request Activity">
            ...
            <div class="col-xs-12">
                ...
                <div class="row item-list-tabs" data-role="tab">
                    <ul class="nav nav-tabs">
                        <li <?if(!$showAllItems):?>class="active"<?endif;?>><a data-toggle="tab" href="#sales-requests-item-list-own">my requests</a></li>
                        <li <?if($showAllItems):?>class="active"<?endif;?>><a data-toggle="tab" href="#sales-requests-item-list-all">all requests</a></li>
                        <li><a data-toggle="tab" href="#sales-requests-item-list-archive">archives</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane <? if (!$showAllItems): ?>active<? endif; ?>" id="sales-requests-item-list-own"></div>
                        <div class="tab-pane <? if ($showAllItems): ?>active<? endif; ?>" id="sales-requests-item-list-all"></div>
                        <div class="tab-pane" id="sales-requests-item-list-archive"></div>
                    </div>
                </div>
                <div class="row item-list-container logger-form" data-log-group="StarsSteals"
                     data-log-action="Sales Request Activity">
                </div>
            </div>
        </div>
    </div>
    <div class="content-panel">
        <div class="item-content logger-form" data-log-group="Item" data-log-action="Sales Request Activity"></div>

<?
	...
	echo $this->renderPartial('landingPageMarkup/style/styleBackground',
		...
		, true);
?>
<div id="<? echo $blockId; ?>" class="col col-lg-<? echo $contentBlock->size->large; ?> col-md-<? echo $contentBlock->size->medium; ?> col-sm-<? echo $contentBlock->size->small; ?> col-xs-<? echo $contentBlock->size->extraSmall; ?>

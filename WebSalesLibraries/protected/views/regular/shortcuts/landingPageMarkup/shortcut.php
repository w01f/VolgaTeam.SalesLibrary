...
?>
<<?echo $contentBlock->buttonize?'button':'a';?> class="<? if ($contentBlock->buttonize): ?>btn btn-default<? else: ?>landing-url<? endif; ?> shortcuts-link" href="<? echo $contentBlock->shortcut->getSourceLink(); ?>" target="_blank"
    ...
    <div class="service-data">
		<? echo $contentBlock->shortcut->getMenuItemData(); ?>
    </div>

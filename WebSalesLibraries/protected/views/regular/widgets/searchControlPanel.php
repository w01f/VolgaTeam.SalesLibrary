		...
		<div id="categories-container">
			<div class="accordion" id="categories">
				<?php foreach ($categories->groups as $group): ?>
					...
					<div>
						<label class="checkbox group-selector-title"><input class="group-selector" type="checkbox" <?php echo $categories->isGroupSelected($group) ? 'checked="checked"' : '' ?>><?php echo $group; ?>
						</label>

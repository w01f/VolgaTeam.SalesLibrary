<?
	...
	use application\models\sales_ideas\models\Content;
	use application\models\sales_ideas\models\ItemEditModel;
	...
	$categoriesList = \application\models\sales_ideas\models\Dictionaries::getCategoriesList();
	$marketList = \application\models\sales_ideas\models\Dictionaries::getMarketList();
...
<div <? if ($item->allowEdit || $isAdminRole): ?>class="editable" <? else: ?>ondragover="return false;"
    ...
    <form class="form-horizontal">
        ...
        <div class="row">
            <div class="col col-xs-12 sales-ideas-item-content-additional-sections">
                <ul class="nav nav-tabs" style="margin-top: 20px;">
                    <li class="active" style="max-width: 150px;"><a data-toggle="tab" href="#sales-ideas-item-tab-info">Info</a></li>
                    <li><a data-toggle="tab" href="#sales-ideas-item-tab-details">Details</a></li>
                    <li><a data-toggle="tab" href="#sales-ideas-item-tab-strategy">Strategy</a></li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="sales-ideas-item-tab-info">
                        <div class="row">
                            <div class="col col-md-3 col-sm-12">
                                <div class="form-group item-content-group" style="margin-top: 20px;">
                                    <label class="control-label" for="sales-ideas-item-revenue">A. revenue</label>
                                    <div class="controls">
                                        <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                            <input id="sales-ideas-item-revenue" type="text" class="form-control" data-role="text"
                            ...
                            <div class="col col-md-8 col-sm-12 text-right">
                                <div class="form-group item-content-group" style="margin-top: 30px;">
                                    ...
                                    <div class="controls">
                                        <label class="radio-inline sales-ideas-item-nomination-type-label" for="sales-ideas-item-nomination-type-1"><input type="radio"
                                                                                                                                                               name="sales-ideas-item-nomination-type"
                                                                                                                                                               value="<? echo Content::NominationTypeShared; ?>"
                                                                                                                                                               class="sales-ideas-item-nomination-type"
                                                                                                                                                               id="sales-ideas-item-nomination-type-1"
                                        ...
                                        <label class="radio-inline sales-ideas-item-nomination-type-label" for="sales-ideas-item-nomination-type-2"><input type="radio"
                                                                                                                                                               value="<? echo Content::NominationTypeOriginal; ?>"
                                                                                                                                                               name="sales-ideas-item-nomination-type"
                                                                                                                                                               class="sales-ideas-item-nomination-type"
                                                                                                                                                               id="sales-ideas-item-nomination-type-2"
                        ...
                        <div class="row">
                            <div class="col col-md-6 col-sm-12">
                                <div class="form-group item-content-group">
                                    <label class="control-label" for="sales-ideas-item-advertiser">B. client/advertiser</label>
                                    <div class="controls">
                                        <input id="sales-ideas-item-advertiser" type="text" class="form-control" data-role="text"
                            ...
                            <div class="col col-md-6 col-sm-12">
                                <div class="form-group item-content-group">
                                    <div class="controls">
                                        <label class="control-label" for="sales-ideas-item-category">C. advertiser category</label>
			                            <? if ($item->allowEdit || $isAdminRole): ?>
                                            <div class="input-group popup-list-editor-container sales-ideas-item-category-container">
                                                <div class="service-data popup-list-content">
                                                    <img src="<? echo Yii::app()->baseUrl . '/images/sales-ideas/category-selector-logo.svg' ?>"
                                                         style="height: 100px;">
                                                ...
                                                <input type="text" id="sales-ideas-item-category"
                        ...
                        <div class="row">
                            <div class="col col-md-6 col-sm-12">
                                <div class="form-group item-content-group">
                                    <label class="control-label" for="sales-ideas-item-seller">D. seller</label>
                                    <div class="controls">
                                        <input id="sales-ideas-item-seller" type="text" class="form-control" data-role="text"
                            ...
                            <div class="col col-md-6 col-sm-12">
                                <div class="form-group item-content-group">
                                    <label class="control-label" for="sales-ideas-item-market">E. media property</label>
                                    <div class="controls">
			                            <? if ($item->allowEdit || $isAdminRole): ?>
                                            <div class="input-group popup-list-editor-container sales-ideas-item-market-container">
                                                <div class="service-data popup-list-content">
                                                    <img src="<? echo Yii::app()->baseUrl . '/images/sales-ideas/market-selector-logo.svg' ?>"
                                                         style="height: 100px;">
                                                    <div class="list-group"
                                                         style="height: 450px; overflow-y: auto !important;">
                                                ...
                                                <input type="text" id="sales-ideas-item-market"
                                                       class="form-control editor"
			                            ...
			                            <? else: ?>
                                            <input type="text" id="sales-ideas-item-market" class="form-control"
                        ...
                        <div class="row">
                            <div class="col col-xs-12">
                                <div class="panel panel-default sales-ideas-item-attachments" data-role="panel" style="margin-top: 60px;">
                                    ...
                                    <div class="panel-body" style="min-height: 170px;">
                                        <ul class="nav nav-pills dropzone<? if (!($item->allowEdit || $isAdminRole)): ?> disabled<? endif; ?>"
                                            id="sales-ideas-item-attachments-data" style="min-height: 170px;">
                    ...
                    <div class="tab-pane" id="sales-ideas-item-tab-details">
                        <div class="row">
                            <div class="col col-xs-12">
                                <div class="form-group item-content-group" style="margin-top: 20px;">
                                    <label class="control-label">G. revenue type:</label>
                                    <div class="controls">
                                        <label class="radio-inline" for="sales-ideas-item-revenue-type-1"><input type="radio"
                                                                                                                   value="<? echo Content::RevenueTypeNew; ?>"
                                                                                                                   name="sales-ideas-item-revenue-type"
                                                                                                                   class="sales-ideas-item-revenue-type"
                                                                                                                   id="sales-ideas-item-revenue-type-1"
                                        ...
                                        <label class="radio-inline" for="sales-ideas-item-revenue-type-2"><input type="radio"
                                                                                                                   value="<? echo Content::RevenueTypeIncremental; ?>"
                                                                                                                   name="sales-ideas-item-revenue-type"
                                                                                                                   class="sales-ideas-item-revenue-type"
                                                                                                                   id="sales-ideas-item-revenue-type-2"
                        ...
                        <div class="row">
                            <div class="col col-md-6 col-sm-12">
                                <div class="form-group item-content-group">
                                    <label class="control-label"
                                           for="sales-ideas-item-revenue-digital">H. digital revenue</label>
                                    <div class="controls">
                                        <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                            <input id="sales-ideas-item-revenue-digital" type="text"
                            ...
                            <div class="col col-md-6 col-sm-12">
                                <div class="form-group item-content-group">
                                    <label class="control-label"
                                           for="sales-ideas-item-revenue-media">I. tv revenue</label>
                                    <div class="controls">
                                        <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                            <input id="sales-ideas-item-revenue-media" type="text"
                                                   class="form-control" data-role="text"
                        ...
                        <div class="row">
                            <div class="col col-md-6 col-sm-12">
                                <div class="form-group item-content-group">
                                    <label class="control-label"
                                           for="sales-ideas-item-revenue-production">J. production revenue</label>
                                    <div class="controls">
                                        <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                            <input id="sales-ideas-item-revenue-production" type="text"
                                                   class="form-control" data-role="text"
                            ...
                            <div class="col col-md-6 col-sm-12">
                                <div class="form-group item-content-group">
                                    <label class="control-label"
                                           for="sales-ideas-item-revenue-other">K. other revenue</label>
                                    <div class="controls">
                                        <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                            <input id="sales-ideas-item-revenue-other" type="text"
                                                   class="form-control" data-role="text"
                        ...
                        <div class="row">
                            <div class="col col-xs-12">
                                <style>
                                    #content .sales-ideas-main-page .item-content .item-content-group.platform-container .checkbox
                                    {
                                        margin-top: 20px;
                                    }
                                </style>
                                        ...
                                        <div class="row">
                                            <div class="col col-md-3 col-sm-6 col-xs-12">
                                                <label class="checkbox"
                                                       for="sales-ideas-item-details-platform-1"><input
                                                            type="checkbox"
                                                            value="<? echo Content::DigitalPlatformNetwork; ?>"
                                                            class="sales-ideas-item-details-platform"
                                                            id="sales-ideas-item-details-platform-1"
                                                ...
                                                <label class="checkbox"
                                                       for="sales-ideas-item-details-platform-3"><input
                                                            type="checkbox"
                                                            value="<? echo Content::DigitalPlatformNativeAdvertorial; ?>"
                                                            class="sales-ideas-item-details-platform"
                                                            id="sales-ideas-item-details-platform-3"
                                            ...
                                            <div class="col col-md-3 col-sm-6 col-xs-12">
                                                <label class="checkbox"
                                                       for="sales-ideas-item-details-platform-4"><input
                                                            type="checkbox"
                                                            value="<? echo Content::DigitalPlatformMobile; ?>"
                                                            class="sales-ideas-item-details-platform"
                                                            id="sales-ideas-item-details-platform-4"
                                                ...
                                                <label class="checkbox"
                                                       for="sales-ideas-item-details-platform-6"><input
                                                            type="checkbox"
                                                            value="<? echo Content::DigitalPlatformOtt; ?>"
                                                            class="sales-ideas-item-details-platform"
                                                            id="sales-ideas-item-details-platform-6"
                                            ...
                                            <div class="col col-md-3 col-sm-6 col-xs-12">
                                                <label class="checkbox"
                                                       for="sales-ideas-item-details-platform-2"><input
                                                            type="checkbox"
                                                            value="<? echo Content::DigitalPlatformSite; ?>"
                                                            class="sales-ideas-item-details-platform"
                                                            id="sales-ideas-item-details-platform-2"
                                                ...
                                                <label class="checkbox"
                                                       for="sales-ideas-item-details-platform-7"><input
                                                            type="checkbox"
                                                            value="<? echo Content::DigitalPlatformAdvancedWeb; ?>"
                                                            class="sales-ideas-item-details-platform"
                                                            id="sales-ideas-item-details-platform-7"
                                            ...
                                            <div class="col col-md-3 col-sm-6 col-xs-12">
                                                <label class="checkbox"
                                                       for="sales-ideas-item-details-platform-5"><input
                                                            type="checkbox"
                                                            value="<? echo Content::DigitalPlatformGeoTargeting; ?>"
                                                            class="sales-ideas-item-details-platform"
                                                            id="sales-ideas-item-details-platform-5"
                    ...
                    <div class="tab-pane" id="sales-ideas-item-tab-strategy">
                        <div class="row">
                            <div class="col col-xs-12">
                                <div class="form-group item-content-group" style="margin-top: 20px;">
                                    <label class="control-label" for="sales-ideas-item-team-members">M. Did any other key team members contribute to this sale?</label>
                                    <div class="controls">
                                            <textarea id="sales-ideas-item-team-members" rows="3"
                                                      class="form-control"
                        ...
                        <div class="row">
                            <div class="col col-xs-12">
                                <div class="form-group item-content-group">
                                    <label class="control-label" for="sales-ideas-item-success-story">N. What is it about this success story or BIG Idea that makes it a great opportunity for other Gray Markets?</label>
                                    <div class="controls">
                                            <textarea id="sales-ideas-item-success-story" rows="3"
                                                      class="form-control"
                        ...
                        <div class="row">
                            <div class="col col-xs-12">
                                <div class="form-group item-content-group">
                                    <label class="control-label" for="sales-ideas-item-milestones">O. What made this a “Creative” sale? What key milestones did you accomplish to close this deal?</label>
                                    <div class="controls">
                                            <textarea id="sales-ideas-item-milestones" rows="3"
                                                      class="form-control"

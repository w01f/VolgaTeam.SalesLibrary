...
<div class="banner-container" <?php if (isset($tooltip)): ?>rel="tooltip"
	...
	<span class="<?echo $isLinkBanner ? 'banner-text-link' : 'banner-text';?>"
		  style="font-family: <?php echo $banner->font->name; ?>,serif;
				  font-size: <?php echo $banner->font->size; ?>pt;
				  font-weight: <?php echo $banner->font->isBold ? ' bold' : ' normal'; ?>;
				  font-style: <?php echo $banner->font->isItalic ? ' italic' : ' normal'; ?>;
				  color: <?php echo $banner->foreColor; ?>;">
			<?echo $banner->text;?>
	</span>
</div>
<? else: ?>

<table class="tool-dialog">
	...
	<tr>
		<td style="text-align: center;">
			<br><a href="mailto:<?php echo Yii::app()->params['email']['help_request_address']; ?>?subject=Site Help Request - <? echo Yii::app()->request->serverName; ?>"><u><b>Click Here</b></u></a> if you are

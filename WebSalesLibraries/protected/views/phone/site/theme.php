<? if (Yii::app()->params['jqm_theme']['enabled'] === true): ?>
	<style>
		...
		#jqm-markup .ui-page-theme-a .ui-checkbox-on:after,
		#jqm-markup .ui-bar-a .ui-checkbox-on:after,
		#jqm-markup .ui-body-a .ui-checkbox-on:after,
		#jqm-markup .ui-group-theme-a .ui-checkbox-on:after,
		#jqm-markup .ui-btn.ui-checkbox-on.ui-btn-a:after,

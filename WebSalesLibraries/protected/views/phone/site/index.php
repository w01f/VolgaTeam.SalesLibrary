<?
	...
	$cs->registerCssFile(Yii::app()->getBaseUrl(true) . '/vendor/mobiscroll/css/mobiscroll-2.1.custom.min.css?' . Yii::app()->params['version']);
	...
	$cs->registerScriptFile(Yii::app()->getBaseUrl(true) . '/js/phone/controller.js?' . Yii::app()->params['version'], CClientScript::POS_HEAD);

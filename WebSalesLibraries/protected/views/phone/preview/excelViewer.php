	...
	<div data-role='page' id="link-viewer" class="link-viewer-page" data-cache="never" data-dom-cache="false" data-ajax="false">
		...
		<div data-role='content' class="main-content">
			...
			<? if ($data->config->allowPreview): ?>
				<div class="actions">
                    <div class="ui-grid-a">
                        <div class="ui-block-a">
                            <a href="<? echo $data->oneDriveUrl; ?>" target="_blank" data-role="button" data-inline="true" data-theme="a">Open</a>
                        </div>
                ...
                <div class="thumbnail">
                    <img src="<? echo $data->thumbImageSrc; ?>">
                </div>
			<? else: ?>
				<p>Sorry...</p>

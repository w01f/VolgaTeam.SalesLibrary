<table class="layout-group">
    <tr>
        <td class="on-left">
            <a id="search-file-types-select-button" href="#" data-role="button" data-mini="true" data-icon="check" data-inline="true" data-theme="b">Select All</a>
        </td>
        <td class="on-right">
            <a id="search-file-types-clear-button" href="#" data-role="button" data-mini="true" data-icon="delete" data-inline="true" data-theme="b">Clear All</a>
        </td>
    </tr>
</table>

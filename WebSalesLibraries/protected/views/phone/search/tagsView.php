<?php if (isset($categories)): ?>
    <table class="layout-group">
        <tr>
            <td class="on-left">
                <a id="search-tags-clear-button" href="#" data-role="button" data-mini="true" data-icon="delete" data-inline="true" data-theme="b">Clear Tags</a>
            </td>
            <td class="on-right">
                <select name="search-tags-exact-match" id="search-tags-exact-match" data-role="slider" data-mini="true" data-track-theme="b">

	...
	<? foreach ($folders as $folder): ?>
        <div class="folder" data-role="collapsible">
            <h3>
                ...
                <a style="float: right" class="delete-button" href="#" data-role="button" data-inline="true"
                   data-iconpos="notext" data-theme="a" data-icon="delete"></a>
            </h3>

...
$cs->registerCssFile(Yii::app()->baseUrl . '/css/search.css?1.0');
$cs->registerCssFile(Yii::app()->baseUrl . '/css/view-dialog.css');
$cs->registerCssFile(Yii::app()->baseUrl . '/css/library-selector.css?1.0');
$cs->registerCssFile(Yii::app()->clientScript->getCoreScriptUrl() . '/jui/css/base/jquery-ui.css');
$cs->registerCoreScript('jquery');
$cs->registerCoreScript('jquery.ui');
$cs->registerCoreScript('cookie');
$cs->registerScriptFile(Yii::app()->baseUrl . '/js/json/jquery.json-2.3.min.js', CClientScript::POS_HEAD);
...
$cs->registerScriptFile(Yii::app()->baseUrl . '/js/librarySelector.js', CClientScript::POS_HEAD);

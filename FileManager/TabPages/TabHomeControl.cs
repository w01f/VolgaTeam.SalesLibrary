    ...
    public partial class TabHomeControl : UserControl
    {
        ...
        public void comboBoxEditLibraries_EditValueChanged(object sender, EventArgs e)
        {
            ...
            if (FormMain.Instance.comboBoxEditLibraries.EditValue != null)
                PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator = PresentationClasses.Decorators.DecoratorManager.Instance.Decorators.Where(x => x.Library.Name.Equals(FormMain.Instance.comboBoxEditLibraries.EditValue.ToString())).FirstOrDefault();
            else
                PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator = null;
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
            {
                BusinessClasses.LibraryManager.Instance.SelectedLibrary = PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library;
        ...
        public void comboBoxEditPages_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
            {
                ...
                PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.SelectPage(FormMain.Instance.comboBoxEditPages.SelectedIndex);
            }
        }
                    ...
                    if (form.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        using (ToolForms.FormProgress formProgress = new ToolForms.FormProgress())
                        {
                            ...
                            System.Threading.Thread thread = new System.Threading.Thread(new System.Threading.ThreadStart(delegate()
                            {
                                ...
                                {
                                    PresentationClasses.Decorators.DecoratorManager.Instance.BuildDecorators();
                                });
                            }));
        ...
        public void buttonItemSettingsBranding_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
            {
                using (SettingsForms.FormBranding form = new SettingsForms.FormBranding())
                {
                    form.ShowDialog();
                }
            }
        ...
        public void buttonItemSettingsSync_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
            {
                using (SettingsForms.FormSync form = new SettingsForms.FormSync())
                {
                    form.ShowDialog();
                }
            }
        ...
        public void buttonItemSettingsPages_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
            {
                if (SaveLibraryWarning())
                {
                    using (SettingsForms.FormPages form = new SettingsForms.FormPages())
                    {
                        form.Library = new BusinessClasses.Library(PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.Name, PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.Folder);
                        if (form.ShowDialog() == DialogResult.OK)
                        {
                            using (ToolForms.FormProgress formProgress = new ToolForms.FormProgress())
                            {
                                ...
                                System.Threading.Thread thread = new System.Threading.Thread(new System.Threading.ThreadStart(delegate()
                                {
                                    this.Invoke((MethodInvoker)delegate()
                                    {
                                        int libraryIndex = BusinessClasses.LibraryManager.Instance.LibraryCollection.IndexOf(PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library);
                                        BusinessClasses.LibraryManager.Instance.LibraryCollection.Remove(PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library);
                                        BusinessClasses.LibraryManager.Instance.LibraryCollection.Insert(libraryIndex, form.Library);

                                        PresentationClasses.Decorators.DecoratorManager.Instance.Decorators.Remove(PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator);
                                        PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator = new PresentationClasses.Decorators.LibraryDecorator(form.Library);
                                        PresentationClasses.Decorators.DecoratorManager.Instance.Decorators.Add(PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator);
                                    });
                                }));
        ...
        public void buttonItemSettingsColumns_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
            {
                if (SaveLibraryWarning())
                {
                    using (SettingsForms.FormColumns form = new SettingsForms.FormColumns())
                    {
                        form.Library = new BusinessClasses.Library(PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.Name, PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.Folder);
                        if (form.ShowDialog() == DialogResult.OK)
                        {
        ...
        public void buttonItemSettingsAutoWidgets_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
            {
                if (SaveLibraryWarning())
                {
                    using (SettingsForms.FormAutoWidgets form = new SettingsForms.FormAutoWidgets())
                    {
                        form.Library = new BusinessClasses.Library(PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.Name, PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.Folder);
                        if (form.ShowDialog() == DialogResult.OK)
                        {
        ...
        public void buttonItemSettingsDeadLinks_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
            {
                if (SaveLibraryWarning())
                {
                    using (SettingsForms.FormDeadLinks form = new SettingsForms.FormDeadLinks())
                    {
                        form.Library = new BusinessClasses.Library(PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.Name, PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.Folder);
                        if (form.ShowDialog() == DialogResult.OK)
                        {
        ...
        public void buttonItemSettingsEmailList_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
            {
                using (SettingsForms.FormEmailList form = new SettingsForms.FormEmailList())
                {
                    form.ShowDialog();
                }
            }
        ...
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
                if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage != null)
                    if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox != null)
                        PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox.AddUrl();
        }
        ...
        public void btAddNeworkShare_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
                if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage != null)
                    if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox != null)
                        PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox.AddNetworkFolder();
        }
        ...
        public void btLineBreak_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
                if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage != null)
                    if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox != null)
                        PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox.AddLineBreak();
        }
        ...
        public void btDownLink_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
                if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage != null)
                    if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox != null)
                        PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox.DownLink();
        }
        ...
        public void btUpLink_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
                if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage != null)
                    if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox != null)
                        PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox.UpLink();
        }
        ...
        public void btOpenLink_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
                if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage != null)
                    if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox != null)
                        PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox.OpenLink();
        }
        ...
        public void btDeleteLink_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
                if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage != null)
                    if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox != null)
                        PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox.DeleteLink();
        }
        ...
        public void btFontUp_Click(object sender, EventArgs e)
        {
            ...
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
                PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.FitObjectsToPage();
            pnMain.Focus();
        }
        ...
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
                PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ActivePage.ActiveBox.ShowLinkProperties(Point.Empty);
        }

        public void btSave_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
                PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Save();
        ...
        public void btSync_Click(object sender, EventArgs e)
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
            {
                using (ToolForms.FormProgress form = new ToolForms.FormProgress())
                {
                    ...
                    if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.ShowProgressDuringSync)
                        form.Show();
                    if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.MinimizeOnSync)
                    ...
                    FormMain.Instance.ribbonControl.Enabled = true;
                    pnMain.Enabled = true;
                    if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.CloseAfterSync)
                        Application.Exit();
                }
            }
        }
        ...
        private void FillPages()
        {
            ...
            if (!ConfigurationClasses.SettingsManager.Instance.MultitabView)
            {
                ...
                if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
                {
                    FormMain.Instance.comboBoxEditPages.Properties.Items.AddRange(PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.Pages.Select(y => y.Name).ToArray());
        ...
        private void BuildTreeView()
        {
            ...
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
                _treeList.Init(PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.Folder);
        ...
        private void ApplyDecorator()
        {
            ...
            foreach (Control control in FormMain.Instance.TabHome.pnMain.Controls)
                control.Parent = null;
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.IsConfigured)
            {
                btSetupWallBin.Visible = false;
                PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.ApplyDecorator(_firstRun);
            }
            else
            {
        ...
        private bool SaveLibraryWarning()
        {
            if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator != null)
            {
                if (PresentationClasses.Decorators.DecoratorManager.Instance.ActiveDecorator.StateChanged)
                {

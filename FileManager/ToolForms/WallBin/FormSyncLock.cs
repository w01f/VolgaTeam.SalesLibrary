...
namespace FileManager.ToolForms.WallBin
{
	public partial class FormSyncLock : MetroForm
	{
		public FormSyncLock(int noTags, int inactive, int noVideo)
		{
			...
			labelControlContacts.Text = String.Format(labelControlContacts.Text, "127.0.0.1", SettingsManager.Instance.SyncSupportEmail);
		}
		...
		{
			Process.Start(String.Format("mailto:{0}", SettingsManager.Instance.SyncSupportEmail));
		}

    ...
    public partial class FormBranding : Form
    {
        ...
        private void Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (this.DialogResult == System.Windows.Forms.DialogResult.OK)
            {
                ...
                e.Cancel = false;
                PresentationClasses.WallBin.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.BrandingText = textEditBrandingName.EditValue.ToString();
        ...
        {
            textEditBrandingName.EditValue = PresentationClasses.WallBin.Decorators.DecoratorManager.Instance.ActiveDecorator.Library.BrandingText;
        }
    }
}

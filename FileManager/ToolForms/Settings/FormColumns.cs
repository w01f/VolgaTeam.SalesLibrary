...
namespace FileManager.ToolForms.Settings
{
	public partial class FormColumns : MetroForm
	{
		...
		private bool _column1FirstSelect = true;
		private bool _column2FirstSelect = true;
		private bool _column3FirstSelect = true;
		private LibraryFolder _currentFolder;
		private LibraryPage _currentPage;
		private bool _stateChanges;
		...
		public FormColumns()
		{
			...
			{
				laWindowHeaderBackColor.Font = new Font(laWindowHeaderBackColor.Font.FontFamily, laWindowHeaderBackColor.Font.Size - 2, laWindowHeaderBackColor.Font.Style);
				laWindowHeaderFont.Font = new Font(laWindowHeaderFont.Font.FontFamily, laWindowHeaderFont.Font.Size - 2, laWindowHeaderFont.Font.Style);
				laWindowHeaderForeColor.Font = new Font(laWindowHeaderForeColor.Font.FontFamily, laWindowHeaderForeColor.Font.Size - 2, laWindowHeaderForeColor.Font.Style);
				laLocationHeader.Font = new Font(laLocationHeader.Font.FontFamily, laLocationHeader.Font.Size - 2, laLocationHeader.Font.Style);
				laLocationValue.Font = new Font(laLocationValue.Font.FontFamily, laLocationValue.Font.Size - 2, laLocationValue.Font.Style);
				laWindowBorderColor.Font = new Font(laWindowBorderColor.Font.FontFamily, laWindowBorderColor.Font.Size - 2, laWindowBorderColor.Font.Style);
				laPages.Font = new Font(laPages.Font.FontFamily, laPages.Font.Size - 2, laPages.Font.Style);
				laWindow.Font = new Font(laWindow.Font.FontFamily, laWindow.Font.Size - 2, laWindow.Font.Style);
				laWindowBackColor.Font = new Font(laWindowBackColor.Font.FontFamily, laWindowBackColor.Font.Size - 2, laWindowBackColor.Font.Style);
				laWindowForeColor.Font = new Font(laWindowForeColor.Font.FontFamily, laWindowForeColor.Font.Size - 2, laWindowForeColor.Font.Style);
				laWindowHeaderAlignment.Font = new Font(laWindowHeaderAlignment.Font.FontFamily, laWindowHeaderAlignment.Font.Size - 2, laWindowHeaderAlignment.Font.Style);
				laWindowAvailableBanners.Font = new Font(laWindowAvailableBanners.Font.FontFamily, laWindowAvailableBanners.Font.Size - 2, laWindowAvailableBanners.Font.Style);
				laWindowBannerAligment.Font = new Font(laWindowBannerAligment.Font.FontFamily, laWindowBannerAligment.Font.Size - 2, laWindowBannerAligment.Font.Style);
				laWindowSelectedBanner.Font = new Font(laWindowSelectedBanner.Font.FontFamily, laWindowSelectedBanner.Font.Size - 2, laWindowSelectedBanner.Font.Style);
				laWindowAvailableWidgets.Font = new Font(laWindowAvailableWidgets.Font.FontFamily, laWindowAvailableWidgets.Font.Size - 2, laWindowAvailableWidgets.Font.Style);
				laWindowSelectedWidget.Font = new Font(laWindowSelectedWidget.Font.FontFamily, laWindowSelectedWidget.Font.Size - 2, laWindowSelectedWidget.Font.Style);
				...
				ckWindowEnableBanner.Font = new Font(ckWindowEnableBanner.Font.FontFamily, ckWindowEnableBanner.Font.Size - 2, ckWindowEnableBanner.Font.Style);
				ckWindowBannerShowText.Font = new Font(ckWindowBannerShowText.Font.FontFamily, ckWindowBannerShowText.Font.Size - 2, ckWindowBannerShowText.Font.Style);
				...
				ckWindowEnableWidget.Font = new Font(ckWindowEnableWidget.Font.FontFamily, ckWindowEnableWidget.Font.Size - 2, ckWindowEnableWidget.Font.Style);
				rbWindowHeaderAlignmentCenter.Font = new Font(rbWindowHeaderAlignmentCenter.Font.FontFamily, rbWindowHeaderAlignmentCenter.Font.Size - 2, rbWindowHeaderAlignmentCenter.Font.Style);
				rbWindowHeaderAlignmentLeft.Font = new Font(rbWindowHeaderAlignmentLeft.Font.FontFamily, rbWindowHeaderAlignmentLeft.Font.Size - 2, rbWindowHeaderAlignmentLeft.Font.Style);
				...
				rbWindowBannerAlignmentCenter.Font = new Font(rbWindowBannerAlignmentCenter.Font.FontFamily, rbWindowBannerAlignmentCenter.Font.Size - 2, rbWindowBannerAlignmentCenter.Font.Style);
				rbWindowBannerAlignmentLeft.Font = new Font(rbWindowBannerAlignmentLeft.Font.FontFamily, rbWindowBannerAlignmentLeft.Font.Size - 2, rbWindowBannerAlignmentLeft.Font.Style);
				rbWindowBannerAlignmentRight.Font = new Font(rbWindowBannerAlignmentRight.Font.FontFamily, rbWindowBannerAlignmentRight.Font.Size - 2, rbWindowBannerAlignmentRight.Font.Style);
				...
				xtraTabControlColumnTitles.Appearance.Font = new Font(xtraTabControlColumnTitles.Appearance.Font.FontFamily, xtraTabControlColumnTitles.Appearance.Font.Size - 2, xtraTabControlColumnTitles.Appearance.Font.Style);
				xtraTabControlColumnTitles.AppearancePage.Header.Font = new Font(xtraTabControlColumnTitles.AppearancePage.Header.Font.FontFamily, xtraTabControlColumnTitles.AppearancePage.Header.Font.Size - 2, xtraTabControlColumnTitles.AppearancePage.Header.Font.Style);
				xtraTabControlColumnTitles.AppearancePage.HeaderActive.Font = new Font(xtraTabControlColumnTitles.AppearancePage.HeaderActive.Font.FontFamily, xtraTabControlColumnTitles.AppearancePage.HeaderActive.Font.Size - 2, xtraTabControlColumnTitles.AppearancePage.HeaderActive.Font.Style);
				xtraTabControlColumnTitles.AppearancePage.HeaderDisabled.Font = new Font(xtraTabControlColumnTitles.AppearancePage.HeaderDisabled.Font.FontFamily, xtraTabControlColumnTitles.AppearancePage.HeaderDisabled.Font.Size - 2, xtraTabControlColumnTitles.AppearancePage.HeaderDisabled.Font.Style);
				xtraTabControlColumnTitles.AppearancePage.HeaderHotTracked.Font = new Font(xtraTabControlColumnTitles.AppearancePage.HeaderHotTracked.Font.FontFamily, xtraTabControlColumnTitles.AppearancePage.HeaderHotTracked.Font.Size - 2, xtraTabControlColumnTitles.AppearancePage.HeaderHotTracked.Font.Style);
				...
				laColumn1ForeColor.Font = new Font(laColumn1ForeColor.Font.FontFamily, laColumn1ForeColor.Font.Size - 2, laColumn1ForeColor.Font.Style);
				laColumn1Font.Font = new Font(laColumn1Font.Font.FontFamily, laColumn1Font.Font.Size - 2, laColumn1Font.Font.Style);
				...
				ckColumn1EnableText.Font = new Font(ckColumn1EnableText.Font.FontFamily, ckColumn1EnableText.Font.Size - 2, ckColumn1EnableText.Font.Style);
				ckColumn1EnableBanner.Font = new Font(ckColumn1EnableBanner.Font.FontFamily, ckColumn1EnableBanner.Font.Size - 2, ckColumn1EnableBanner.Font.Style);
				ckColumn1EnableWidget.Font = new Font(ckColumn1EnableWidget.Font.FontFamily, ckColumn1EnableWidget.Font.Size - 2, ckColumn1EnableWidget.Font.Style);
				rbColumn1AlignmentCenter.Font = new Font(rbColumn1AlignmentCenter.Font.FontFamily, rbColumn1AlignmentCenter.Font.Size - 2, rbColumn1AlignmentCenter.Font.Style);
				rbColumn1AlignmentLeft.Font = new Font(rbColumn1AlignmentLeft.Font.FontFamily, rbColumn1AlignmentLeft.Font.Size - 2, rbColumn1AlignmentLeft.Font.Style);
				rbColumn1AlignmentRight.Font = new Font(rbColumn1AlignmentRight.Font.FontFamily, rbColumn1AlignmentRight.Font.Size - 2, rbColumn1AlignmentRight.Font.Style);

				laColumn2BackColor.Font = new Font(laColumn2BackColor.Font.FontFamily, laColumn2BackColor.Font.Size - 2, laColumn2BackColor.Font.Style);
				laColumn2ForeColor.Font = new Font(laColumn2ForeColor.Font.FontFamily, laColumn2ForeColor.Font.Size - 2, laColumn2ForeColor.Font.Style);
				laColumn2Font.Font = new Font(laColumn2Font.Font.FontFamily, laColumn2Font.Font.Size - 2, laColumn2Font.Font.Style);
				laColumn2Alignment.Font = new Font(laColumn2Alignment.Font.FontFamily, laColumn2Alignment.Font.Size - 2, laColumn2Alignment.Font.Style);
				ckColumn2EnableBanner.Font = new Font(ckColumn2EnableBanner.Font.FontFamily, ckColumn2EnableBanner.Font.Size - 2, ckColumn2EnableBanner.Font.Style);
				ckColumn2EnableWidget.Font = new Font(ckColumn2EnableWidget.Font.FontFamily, ckColumn2EnableWidget.Font.Size - 2, ckColumn2EnableWidget.Font.Style);
				ckColumn2EnableText.Font = new Font(ckColumn2EnableText.Font.FontFamily, ckColumn2EnableText.Font.Size - 2, ckColumn2EnableText.Font.Style);
				rbColumn2AlignmentCenter.Font = new Font(rbColumn2AlignmentCenter.Font.FontFamily, rbColumn2AlignmentCenter.Font.Size - 2, rbColumn2AlignmentCenter.Font.Style);
				rbColumn2AlignmentLeft.Font = new Font(rbColumn2AlignmentLeft.Font.FontFamily, rbColumn2AlignmentLeft.Font.Size - 2, rbColumn2AlignmentLeft.Font.Style);
				rbColumn2AlignmentRight.Font = new Font(rbColumn2AlignmentRight.Font.FontFamily, rbColumn2AlignmentRight.Font.Size - 2, rbColumn2AlignmentRight.Font.Style);

				laColumn3BackColor.Font = new Font(laColumn3BackColor.Font.FontFamily, laColumn3BackColor.Font.Size - 2, laColumn3BackColor.Font.Style);
				laColumn3ForeColor.Font = new Font(laColumn3ForeColor.Font.FontFamily, laColumn3ForeColor.Font.Size - 2, laColumn3ForeColor.Font.Style);
				laColumn3Font.Font = new Font(laColumn3Font.Font.FontFamily, laColumn3Font.Font.Size - 2, laColumn3Font.Font.Style);
				laColumn3Alignment.Font = new Font(laColumn3Alignment.Font.FontFamily, laColumn3Alignment.Font.Size - 2, laColumn3Alignment.Font.Style);
				ckColumn3EnableBanner.Font = new Font(ckColumn3EnableBanner.Font.FontFamily, ckColumn3EnableBanner.Font.Size - 2, ckColumn3EnableBanner.Font.Style);
				ckColumn3EnableWidget.Font = new Font(ckColumn3EnableWidget.Font.FontFamily, ckColumn3EnableWidget.Font.Size - 2, ckColumn3EnableWidget.Font.Style);
				ckColumn3EnableText.Font = new Font(ckColumn3EnableText.Font.FontFamily, ckColumn3EnableText.Font.Size - 2, ckColumn3EnableText.Font.Style);
				rbColumn3AlignmentCenter.Font = new Font(rbColumn3AlignmentCenter.Font.FontFamily, rbColumn3AlignmentCenter.Font.Size - 2, rbColumn3AlignmentCenter.Font.Style);
				rbColumn3AlignmentLeft.Font = new Font(rbColumn3AlignmentLeft.Font.FontFamily, rbColumn3AlignmentLeft.Font.Size - 2, rbColumn3AlignmentLeft.Font.Style);
				rbColumn3AlignmentRight.Font = new Font(rbColumn3AlignmentRight.Font.FontFamily, rbColumn3AlignmentRight.Font.Size - 2, rbColumn3AlignmentRight.Font.Style);
			}
		...
		{
			var foldersSortedByName = _currentPage.Folders.OrderBy(x => x.Name);
			var columnOrder = 0;
			foreach (var libraryFolder in foldersSortedByName)
			{
				libraryFolder.ColumnOrder = columnOrder;
				columnOrder++;
				if (columnOrder > 2)
					columnOrder = 0;
			}
			...
			{
				var rowOrder = 0;
				foreach (var libraryFolder in foldersSortedByName.Where(x => x.ColumnOrder == i))
				{
					libraryFolder.RowOrder = rowOrder;
					rowOrder++;
				}
			}
		}
		...
		private void GetColumnSettings()
		{
			...
			{
				foreach (var folder in _currentPage.Folders.OrderBy(x => x.RowOrder))
				{
		...
		private void SaveColumnSettings()
		{
			...
			var existedFolderIDs = new List<Guid>();
			LibraryFolder templateFolder = null;

			if (Library.ApplyAppearanceForAllWindows)
			...
			foreach (LibraryFolder folder in _currentPage.Folders.Where(x => !existedFolderIDs.Contains(x.Identifier)).ToArray())
				folder.RemoveFromParent();

			foreach (DataGridViewRow row in grColumn1.Rows)
			{
				LibraryFolder folder = _currentPage.Folders.Where(x => x.Identifier.Equals(row.Cells[1].Value)).FirstOrDefault();
				if (folder == null)
				{
					folder = new LibraryFolder(_currentPage);
		...
		private void GetWindowSettings()
		{
			if (_currentFolder != null)
			{
				...
				_allowToSave = false;
				LibraryFolder currentPageFolder = _currentPage.Folders.FirstOrDefault();
		...
		private void SaveWindowSettings()
		{
			if (_currentFolder != null)
			{
				...
				{
					foreach (LibraryFolder folder in _currentPage.Folders)
					{
						...
						if (rbWindowHeaderAlignmentLeft.Checked)
							folder.HeaderAlignment = Alignment.Left;
						else if (rbWindowHeaderAlignmentCenter.Checked)
							folder.HeaderAlignment = Alignment.Center;
						else if (rbWindowHeaderAlignmentRight.Checked)
							folder.HeaderAlignment = Alignment.Right;
					}
					Library.ApplyAppearanceForAllWindows = true;
				}
				else
				{
					if (_currentFolder != null)
					{
						...
						if (rbWindowHeaderAlignmentLeft.Checked)
							_currentFolder.HeaderAlignment = Alignment.Left;
						else if (rbWindowHeaderAlignmentCenter.Checked)
							_currentFolder.HeaderAlignment = Alignment.Center;
						else if (rbWindowHeaderAlignmentRight.Checked)
							_currentFolder.HeaderAlignment = Alignment.Right;
						Library.ApplyAppearanceForAllWindows = false;
					}
				}
				...
				if (ckApllyForAllWindowsWidget.Checked && _currentPage.Folders.FirstOrDefault() == _currentFolder)
				{
					...
					Library.ApplyWidgetForAllWindows = true;
				}
				else
				{
					if (_currentFolder != null)
				...
				if (ckApllyForAllWindowsBanner.Checked && _currentPage.Folders.FirstOrDefault() == _currentFolder)
				{
					foreach (LibraryFolder folder in _currentPage.Folders)
					{
						...
						if (rbWindowBannerAlignmentLeft.Checked)
							folder.BannerProperties.ImageAlignement = Alignment.Left;
						else if (rbWindowBannerAlignmentCenter.Checked)
							folder.BannerProperties.ImageAlignement = Alignment.Center;
						else if (rbWindowBannerAlignmentRight.Checked)
							folder.BannerProperties.ImageAlignement = Alignment.Right;
					...
					Library.ApplyBannerForAllWindows = true;
				}
				else
				{
					if (_currentFolder != null)
					{
						...
						if (rbWindowBannerAlignmentLeft.Checked)
							_currentFolder.BannerProperties.ImageAlignement = Alignment.Left;
						else if (rbWindowBannerAlignmentCenter.Checked)
							_currentFolder.BannerProperties.ImageAlignement = Alignment.Center;
						else if (rbWindowBannerAlignmentRight.Checked)
							_currentFolder.BannerProperties.ImageAlignement = Alignment.Right;
						...
						Library.ApplyBannerForAllWindows = false;
					}
				}
			}
		}
		...
		private void PopulatePagesList()
		{
			...
			comboBoxEditPages.Properties.Items.AddRange(Library.Pages.Select(y => y.Name).ToArray());
		...
		private void Form_Load(object sender, EventArgs e)
		{
			...
			ckApllyForAllWindowsAppearance.Checked = Library.ApplyAppearanceForAllWindows;
		...
		private void grColumn_MouseClick(object sender, MouseEventArgs e)
		{
			if (e.Button == MouseButtons.Right)
			{
				...
				tmiPaste.Enabled = FolderCopier.PasteReady;
		...
		private void tmiCut_Click(object sender, EventArgs e)
		{
			...
			if (selectedFolder != null)
			{
				...
				FolderCopier.Copy(workingGrid, workingGrid.SelectedRows[0].Index);
			}
		}
		...
		private void tmiPaste_Click(object sender, EventArgs e)
		{
			...
			{
				case 0:
					FolderCopier.Paste(grColumn1);
					break;
				case 1:
					FolderCopier.Paste(grColumn2);
					break;
				case 2:
					FolderCopier.Paste(grColumn3);
					break;
			}
			_stateChanges = true;
		}
		...
		private void btRight_Click(object sender, EventArgs e)
		{
			...
			if (sourceGrid.SelectedRows.Count > 0)
			{
				...
				{
					FolderCopier.CopiedFolder = selectedFolder;
					FolderCopier.Copy(sourceGrid, sourceGrid.SelectedRows[0].Index);
					FolderCopier.Paste(destGrid);
				}
			}
			_stateChanges = true;
		}
		...
		private void xtraTabControlSettings_SelectedPageChanged(object sender, TabPageChangedEventArgs e)
		{
		...
		private void xtraTabControlWindows_SelectedPageChanged(object sender, TabPageChangedEventArgs e)
		{
			switch (xtraTabControlWindows.SelectedTabPageIndex)
			{
				case 0:
		...
		{
			Point pt = gridControlWindowBanners.PointToClient(MousePosition);
		...
		{
			Point pt = gridControlWindowWidgets.PointToClient(MousePosition);
		...
		private void xtraTabControlColumnTitles_SelectedPageChanged(object sender, TabPageChangedEventArgs e)
		{
		...
		private void rbColumn1AlignmentLeft_CheckedChanged(object sender, EventArgs e)
		{
			if (rbColumn1AlignmentLeft.Checked)
			{
				memoEditColumn1Title.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Near;
				memoEditColumn1Title.Properties.AppearanceDisabled.TextOptions.HAlignment = HorzAlignment.Near;
				memoEditColumn1Title.Properties.AppearanceFocused.TextOptions.HAlignment = HorzAlignment.Near;
				memoEditColumn1Title.Properties.AppearanceReadOnly.TextOptions.HAlignment = HorzAlignment.Near;
			}
			if (_allowToSave)
				_stateChanges = true;
		}
		...
		private void rbColumn1AlignmentCenter_CheckedChanged(object sender, EventArgs e)
		{
			...
			{
				memoEditColumn1Title.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Center;
				memoEditColumn1Title.Properties.AppearanceDisabled.TextOptions.HAlignment = HorzAlignment.Center;
				memoEditColumn1Title.Properties.AppearanceFocused.TextOptions.HAlignment = HorzAlignment.Center;
				memoEditColumn1Title.Properties.AppearanceReadOnly.TextOptions.HAlignment = HorzAlignment.Center;
			}
			if (_allowToSave)
				_stateChanges = true;
		}
		...
		private void rbColumn1AlignmentRight_CheckedChanged(object sender, EventArgs e)
		{
			...
			{
				memoEditColumn1Title.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Far;
				memoEditColumn1Title.Properties.AppearanceDisabled.TextOptions.HAlignment = HorzAlignment.Far;
				memoEditColumn1Title.Properties.AppearanceFocused.TextOptions.HAlignment = HorzAlignment.Far;
				memoEditColumn1Title.Properties.AppearanceReadOnly.TextOptions.HAlignment = HorzAlignment.Far;
			}
			if (_allowToSave)
				_stateChanges = true;
		}
		...
		{
			Point pt = gridControlColumn1Banners.PointToClient(MousePosition);
		...
		{
			Point pt = gridControlColumn1Widgets.PointToClient(MousePosition);
		...
		private void rbColumn2AlignmentLeft_CheckedChanged(object sender, EventArgs e)
		{
			if (rbColumn2AlignmentLeft.Checked)
			{
				memoEditColumn2Title.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Near;
				memoEditColumn2Title.Properties.AppearanceDisabled.TextOptions.HAlignment = HorzAlignment.Near;
				memoEditColumn2Title.Properties.AppearanceFocused.TextOptions.HAlignment = HorzAlignment.Near;
				memoEditColumn2Title.Properties.AppearanceReadOnly.TextOptions.HAlignment = HorzAlignment.Near;
			}
			if (_allowToSave)
				_stateChanges = true;
		}
		...
		private void rbColumn2AlignmentCenter_CheckedChanged(object sender, EventArgs e)
		{
			...
			{
				memoEditColumn2Title.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Center;
				memoEditColumn2Title.Properties.AppearanceDisabled.TextOptions.HAlignment = HorzAlignment.Center;
				memoEditColumn2Title.Properties.AppearanceFocused.TextOptions.HAlignment = HorzAlignment.Center;
				memoEditColumn2Title.Properties.AppearanceReadOnly.TextOptions.HAlignment = HorzAlignment.Center;
			}
			if (_allowToSave)
				_stateChanges = true;
		}
		...
		private void rbColumn2AlignmentRight_CheckedChanged(object sender, EventArgs e)
		{
			...
			{
				memoEditColumn2Title.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Far;
				memoEditColumn2Title.Properties.AppearanceDisabled.TextOptions.HAlignment = HorzAlignment.Far;
				memoEditColumn2Title.Properties.AppearanceFocused.TextOptions.HAlignment = HorzAlignment.Far;
				memoEditColumn2Title.Properties.AppearanceReadOnly.TextOptions.HAlignment = HorzAlignment.Far;
			}
			if (_allowToSave)
				_stateChanges = true;
		}
		...
		{
			Point pt = gridControlColumn2Banners.PointToClient(MousePosition);
		...
		{
			Point pt = gridControlColumn2Widgets.PointToClient(MousePosition);
		...
		private void rbColumn3AlignmentLeft_CheckedChanged(object sender, EventArgs e)
		{
			if (rbColumn3AlignmentLeft.Checked)
			{
				memoEditColumn3Title.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Near;
				memoEditColumn3Title.Properties.AppearanceDisabled.TextOptions.HAlignment = HorzAlignment.Near;
				memoEditColumn3Title.Properties.AppearanceFocused.TextOptions.HAlignment = HorzAlignment.Near;
				memoEditColumn3Title.Properties.AppearanceReadOnly.TextOptions.HAlignment = HorzAlignment.Near;
			}
			if (_allowToSave)
				_stateChanges = true;
		}
		...
		private void rbColumn3AlignmentCenter_CheckedChanged(object sender, EventArgs e)
		{
			...
			{
				memoEditColumn3Title.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Center;
				memoEditColumn3Title.Properties.AppearanceDisabled.TextOptions.HAlignment = HorzAlignment.Center;
				memoEditColumn3Title.Properties.AppearanceFocused.TextOptions.HAlignment = HorzAlignment.Center;
				memoEditColumn3Title.Properties.AppearanceReadOnly.TextOptions.HAlignment = HorzAlignment.Center;
			}
			if (_allowToSave)
				_stateChanges = true;
		}
		...
		private void rbColumn3AlignmentRight_CheckedChanged(object sender, EventArgs e)
		{
			...
			{
				memoEditColumn3Title.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Far;
				memoEditColumn3Title.Properties.AppearanceDisabled.TextOptions.HAlignment = HorzAlignment.Far;
				memoEditColumn3Title.Properties.AppearanceFocused.TextOptions.HAlignment = HorzAlignment.Far;
				memoEditColumn3Title.Properties.AppearanceReadOnly.TextOptions.HAlignment = HorzAlignment.Far;
			}
			if (_allowToSave)
				_stateChanges = true;
		}
		...
		{
			Point pt = gridControlColumn3Banners.PointToClient(MousePosition);
		...
		{
			Point pt = gridControlColumn3Widgets.PointToClient(MousePosition);

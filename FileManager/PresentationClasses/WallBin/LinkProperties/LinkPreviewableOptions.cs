...
{
	public partial class LinkPreviewableOptions : LinkBaseOptions
	{
		public LinkPreviewableOptions()
		{
			InitializeComponent();
		}

		public LinkPreviewableOptions(LibraryLink data)
			: base(data)
		{
			InitializeComponent();
			LoadData();

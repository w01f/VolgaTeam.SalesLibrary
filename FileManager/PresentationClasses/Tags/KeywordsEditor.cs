...
namespace FileManager.PresentationClasses.Tags
{
	...
	public partial class KeywordsEditor : UserControl, ITagsEditor
	{
		...
		public void UpdateData()
		{
			...
			var defaultLink = activePage.SelectedLinks.FirstOrDefault(link => link.HasKeywords) ?? activePage.SelectedLinks.FirstOrDefault();
			Enabled = defaultLink != null;
			if (defaultLink == null) return;

			var noData = activePage.SelectedLinks.All(link => !link.HasKeywords);

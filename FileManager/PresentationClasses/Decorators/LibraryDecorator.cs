...
namespace FileManager.PresentationClasses.Decorators
{
    public class LibraryDecorator
    {
        ...
        public LibraryDecorator(BusinessClasses.Library library)
        {
            ...
            this.OvernightsCalendar = new OvernightsCalendar.OvernightsCalendarControl();
        ...
        {
            using (ToolForms.FormDeleteIncorrectLinks form = new ToolForms.FormDeleteIncorrectLinks())
            {
        ...
        private void ApplyWallBin(bool firstRun)
        {
            ...
            if (this.Library.DeadLinks.Count > 0 && this.Library.EnableInactiveLinks && this.Library.InactiveLinksMessageAtStartup && !BusinessClasses.LibraryManager.Instance.OldStyleProceed && firstRun)
                using (ToolForms.FormIncorrectLinksNotification form = new ToolForms.FormIncorrectLinksNotification())
                {

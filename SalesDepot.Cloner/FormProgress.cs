...
namespace SalesDepot.Cloner
{
	...
	public class FormProgressSyncSource : FormProgress
	{
		protected override void InitForm()
		{
			laProgress.Text = "Cloning Libraries...";
			panelEx.Style.BackColor1.Color = Color.DimGray;
			panelEx.Style.BackColor2.Color = Color.DimGray;
			panelExCancel.Style.BackColor1.Color = Color.DimGray;
			panelExCancel.Style.BackColor2.Color = Color.DimGray;
		}
	}

...
namespace SalesDepot.Services.QBuilderService {
    ...
    public partial class QbuilderControllerService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback setPageLinkOrderOperationCompleted;
        ...
        private System.Threading.SendOrPostCallback setPageOrderOperationCompleted;
        ...
        /// <remarks/>
        public event setPageLinkOrderCompletedEventHandler setPageLinkOrderCompleted;
        ...
        /// <remarks/>
        public event setPageOrderCompletedEventHandler setPageOrderCompleted;
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public QPageModel[] getPagesByUser(string sessionKey, string login) {
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public QPageModel getPageContent(string sessionKey, string pageId) {
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public QPageLinkModel[] getLinkCart(string sessionKey, string login) {
            object[] results = this.Invoke("getLinkCart", new object[] {
                        sessionKey,
                        login});
            return ((QPageLinkModel[])(results[0]));
        }
        ...
        public void addLinksToPage(string sessionKey, string[] linkInCartIds, string pageId, int order) {
        ...
        /// <remarks/>
        public void addLinksToPageAsync(string sessionKey, string[] linkInCartIds, string pageId, int order) {
            this.addLinksToPageAsync(sessionKey, linkInCartIds, pageId, order, null);
        }
        
        /// <remarks/>
        public void addLinksToPageAsync(string sessionKey, string[] linkInCartIds, string pageId, int order, object userState) {
            ...
            this.InvokeAsync("addLinksToPage", new object[] {
                        ...
                        linkInCartIds,
                        pageId,
                        order}, this.addLinksToPageOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:QbuilderControllerwsdl#setPageLinkOrder", RequestNamespace="urn:QbuilderControllerwsdl", ResponseNamespace="urn:QbuilderControllerwsdl")]
        public void setPageLinkOrder(string sessionKey, string pageId, string linkInPageId, int firstLinkOrder) {
            this.Invoke("setPageLinkOrder", new object[] {
                        sessionKey,
                        pageId,
                        linkInPageId,
                        firstLinkOrder});
        ...
        /// <remarks/>
        public void setPageLinkOrderAsync(string sessionKey, string pageId, string linkInPageId, int firstLinkOrder) {
            this.setPageLinkOrderAsync(sessionKey, pageId, linkInPageId, firstLinkOrder, null);
        }
        
        /// <remarks/>
        public void setPageLinkOrderAsync(string sessionKey, string pageId, string linkInPageId, int firstLinkOrder, object userState) {
            if ((this.setPageLinkOrderOperationCompleted == null)) {
                this.setPageLinkOrderOperationCompleted = new System.Threading.SendOrPostCallback(this.OnsetPageLinkOrderOperationCompleted);
            }
            this.InvokeAsync("setPageLinkOrder", new object[] {
                        sessionKey,
                        pageId,
                        linkInPageId,
                        firstLinkOrder}, this.setPageLinkOrderOperationCompleted, userState);
        }
        
        private void OnsetPageLinkOrderOperationCompleted(object arg) {
            if ((this.setPageLinkOrderCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.setPageLinkOrderCompleted(this, new System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:QbuilderControllerwsdl#setPageOrder", RequestNamespace="urn:QbuilderControllerwsdl", ResponseNamespace="urn:QbuilderControllerwsdl")]
        public void setPageOrder(string sessionKey, string login, string pageId, int order) {
            this.Invoke("setPageOrder", new object[] {
                        sessionKey,
                        login,
                        pageId,
                        order});
        ...
        /// <remarks/>
        public void setPageOrderAsync(string sessionKey, string login, string pageId, int order) {
            this.setPageOrderAsync(sessionKey, login, pageId, order, null);
        }
        
        /// <remarks/>
        public void setPageOrderAsync(string sessionKey, string login, string pageId, int order, object userState) {
            if ((this.setPageOrderOperationCompleted == null)) {
                this.setPageOrderOperationCompleted = new System.Threading.SendOrPostCallback(this.OnsetPageOrderOperationCompleted);
            }
            this.InvokeAsync("setPageOrder", new object[] {
                        sessionKey,
                        login,
                        pageId,
                        order}, this.setPageOrderOperationCompleted, userState);
        }
        
        private void OnsetPageOrderOperationCompleted(object arg) {
            if ((this.setPageOrderCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.setPageOrderCompleted(this, new System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    public partial class getLinkCartCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public QPageLinkModel[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((QPageLinkModel[])(this.results[0]));
            }
        }
    }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    public delegate void setPageLinkOrderCompletedEventHandler(object sender, System.ComponentModel.AsyncCompletedEventArgs e);
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    public delegate void setPageOrderCompletedEventHandler(object sender, System.ComponentModel.AsyncCompletedEventArgs e);
}
